  ...
  <main>
    ...
    <section class="formulario">
      <div class="formulario__container">
        ...
        <form action="" class="form" method="post" id="formVizinho">
          <div class="form__holder">
            ...
            <label class="form__input" style="width: 100%" for="email-amigo"><input type="text" id="email-amigo rd-email_field-llpgt1ee" name="cf_email_do_amigo_indicado" type="email" data-use-type="STRING" data-input-mask="" required="required" placeholder="E-mail do amigo indicado" /></label>
          </div>
