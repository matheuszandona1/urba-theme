<?php
/*
Template Name: Smart Urba Dunlop
...
<style>
  ...
  .imagem-smarturba._7.dunlop-img {
    background-image: url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/6-escultura-instagramavel.jpg');
  }
...
<section id="hero-form" class="hero-internas dunlop">
  <div class="container-padrao w-clearfix dunlop">
    <div data-w-id="98b43971-e1eb-15c9-865f-16c97d041b33" class="div-text-hero smart-urba dunlop">
      <div class="div-logo-dunlop" style="position: relative;">
        <img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/logo-smart-urba-dunlop.svg" loading="lazy" width="300" alt="" class="image-23">
        <img src="https://urba.com.br/wp-content/uploads/2023/02/Ativo_2.png" alt="Logo GRI" width="150px" class="logo-gri" style="position: absolute; right: -130px; top: -35px;">
      </div>
      <h1 class="heading-30 h1-dunlop">Smart Urba Dunlop: um <strong class="bold-text-44">bairro inteligente e planejado</strong> para você ser feliz!</h1>
      <p class="paragraph-36 dunlop-sub">Nosso loteamento alia qualidade de vida, mobilidade e acessibilidade à tecnologia e inovação, pensados para o seu bem-estar. Um bairro aberto e inteligente da Urba em Campinas (SP), <strong>feito para você morar ou empreender</strong>. </p>
      <div class="div-tags dunlop">
        <div>
          <!--<div class="tag-hero-2 dunlop-box-hero">Localização incrível</div>
          <div class="tag-hero-2 dunlop-box-hero">Conceito Smart City</div>
          <div class="tag-hero-2 dunlop-box-hero">52 mil m² de áreas verdes</div>
          <div class="tag-hero-2 dunlop-box-hero">LANÇAMENTO NOVA FASE DE 05 A 07/11</div>-->
          <div class="tag-hero-2 dunlop-box-hero" style="color:#fff;border:none;background-image: linear-gradient(304deg,#ffb719,#ff8b22);">FINANCIAMENTO PRÓPRIO SEM BUROCRACIA</div>
          <div class="tag-hero-2 dunlop-box-hero" style="color:#fff;border:none;background-image: linear-gradient(304deg,#ffb719,#ff8b22);">ENTRADA FACILITADA</div>
          <!--<div class="tag-hero-2 dunlop-box-hero">LANÇAMENTO DE 11 A 13/06</div>-->
          <!-- <div class="tag-hero-2 dunlop-box-hero" style="color:#fff;border:none;background-image: linear-gradient(304deg,#ffb719,#ff8b22);">ITBI E REGISTRO GRÁTIS</div> -->
        </div>
      </div>
    </div>
      ...
      <div class="div-forms-hero">
        ...
        <div class="w-form">
          <form id="email-form" name="email-form" data-name="Email Form" class="form-5">
            ...
            <input type="tel" class="campo-form-lp-2 w-input" minlength="15" maxlength="15" onkeypress="MascaraTelefone(this);" name="Telefone" data-name="Telefone" id="Telefone" required="">
            <label for="Menu-suspenso" class="label-form-lp-2 dunlop">Escolha um tipo de lote</label>
            <select id="Menu-suspenso" name="Menu-suspenso" data-name="Menu suspenso" required="" class="select-field-6 dunlop w-select">
              <option value="Selecione">Selecione</option>
              <option value="Lote Residencial">Lote Residencial</option>
            ...
            <div class="w-row bloco_consentimento">
              <div class="w-col">
                ...
                <p class="texto-politica">Aceito receber via WhatsApp, ligação, e-mail e SMS, o contato da marca MRV&CO com novidades sobre este loteamento, bem como outras ações de marketing, ofertas de produto e serviços. Estou de acordo com as formas de tratamento de dados realizados pela marca MRV&CO, conforme sua <a href="https://mrv.com.br/institucional/pt/politica-de-privacidade">Política de Privacidade</a>.</p>
            ...
            <input type="submit" value="enviar" data-wait="Aguarde..." class="enviar-form-lp-3 w-button">
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="tag-breve-lan-amento comercial dunlop">
    <!--<div class="text-block-47 dunlop">   breve lançamento</div>-->
    <div class="text-block-47 dunlop" style="background-image: linear-gradient(
45deg, #793F98 , #793F98 );">EM OBRAS</div>
  </div>
</section>
<div class="planejamento-inteligente">
  <div class="container-padrao">
    <h2 class="heading-27 center _32px"><strong class="destaque-h2-2">Planejamento inteligente </strong>em cada detalhe</h2>
    <div class="columns-21 w-row">
      <div class="column-61 dunlop w-col w-col-4 w-col-stack">
        <p class="paragraph-37">Toda a<strong class="bold-text-4"> infraestrutura </strong>do Smart Urba Dunlop foi pensada para oferecer conforto, bem-estar e praticidade para o seu dia a dia. Por isso, <strong class="bold-text-4">planejamos cada detalhe</strong>, dando atenção ao que vai desde as suas necessidades mais básicas até os recursos <strong class="bold-text-4">inteligentes</strong> que um bairro aberto pode oferecer.</p>
        <div class="tag-hero-2 section2 dunlop">Lotes comerciais e residenciais a partir de <strong class="bold-text-43">126 m²</strong>, que vão muito além de seus m²</div>
      </div>
      <div class="column-60 dunlop w-col w-col-8 w-col-stack">
        <div data-w-id="b404bacf-4e4c-cff1-eb4c-ed98ca21ae02" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-01.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Vias asfaltadas</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-02.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Rede de água, esgoto e energia</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-03.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Rampas acessíveis e piso tátil</div>
          </div>
        </div>
        <div data-w-id="162a7fbd-a09f-bd0e-5e1e-e510ea80f8e1" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-04.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Áreas verdes e projeto paisagístico</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-05.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Fácil acesso ao transporte público</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-06.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Avenidas centrais com áreas destinadas ao comércio</div>
          </div>
        </div>
        <div data-w-id="245d076c-2606-20c8-0ec1-a1ecf011d6e0" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-07.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Áreas de convivência e lazer para todas as idades</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-08.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Aplicativo do bairro</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-23.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Associação de moradores e gestor social</div>
          </div>
        </div>
      </div>
    </div>
    <!--<div class="columns _2 w-row">
      <div class="column _2 interna dunlop w-col w-col-4">
        <div class="text-block-4 _2 interna">Financiamento direto com a loteadora</div>
      </div>
      <div class="column _2 interna dunlop w-col w-col-4">
        <div class="text-block-4 _2 interna">Parcelas mensais a partir de R$XXX</div>
      </div>
      <div class="column _2 interna dunlop w-col w-col-4">
        <div class="text-block-4 _2 interna">Lançamento dos dias 11 a 13 de junho de 2021<br></div>
      </div>
    </div>-->
  </div>
</div>
<div class="localizacao-dunlop">
  <div class="container-padrao">
    <h2 class="heading-27 center _32px">Conheça a localização<strong class="destaque-h2-2"> do seu futuro</strong></h2>
    <div class="div-paragraph-center">
      <p class="paragraph-37">O Smart Urba Dunlop está localizado às margens da Av. Edson Luiz Rigonatto, a 5 minutos da Av. John Boyd Dunlop e a 600m do Terminal, na região do Campo Grande, em Campinas (SP). Assim, você tem acesso a uma <strong class="bold-text-4">região movimentada</strong>, populosa e <strong class="bold-text-4">comercialmente ativa</strong>, mas com a sua <strong class="bold-text-4">segurança garantida</strong>.<br></p>
    </div>
    ...
    <!-- FIM TRECHO MAPA INTERATIVO -->

    <!-- TABS BOOTSTRAP -->
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" id="mapa-tab" data-bs-toggle="tab" data-bs-target="#mapa" type="button" role="tab" aria-controls="mapa" aria-selected="true">Mapa</button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="visao-tab" data-bs-toggle="tab" data-bs-target="#visao" type="button" role="tab" aria-controls="visao" aria-selected="false">Visão 360º</button>
      </li>
    </ul>
    <div class="tab-content" id="myTabContent">
      <div class="tab-pane fade show active" id="mapa" role="tabpanel" aria-labelledby="mapa-tab">
        <div class="div-mapa-dunlop">
          ...
          <div id="map"></div>
          <script src="https://maps.almav.com/maps/api/js?key=68a8e9d4-18b8-4d27-8a0d-cb5f0ce68a31&callback=initMap" async></script>
        </div>
      </div>
      <div class="tab-pane fade" id="visao" role="tabpanel" aria-labelledby="visao-tab">
        <div class="div-mapa-dunlop">
          <iframe id="visao-360" allowfullscreen src="https://skylineip.s3-sa-east-1.amazonaws.com/Tour+Virtual/Urba/Dunlop/index.htm"></iframe>
        </div>
      </div>
    </div>
...
<!-- <div class="galeria-de-fotos-2">
  <div class="columns-6 w-row">
    <div class="column-68 w-col w-col-6 w-col-medium-6">
      <div class="seta-2"></div>
      <div class="div-title-info-galeria dunlop">
        <h2 class="heading-27 galeria _32px"><strong class="bold-text-42">Explore</strong> o Loteamento na Galeria</h2>
        <a href="#" class="button-14 galeria w-button">Adquira já esse terreno</a>
      </div>
    </div>
    <?php $images = acf_photo_gallery('galeria', $post->ID); ?>
    <div class="column-26 w-col w-col-6 w-col-medium-6">
            ...
            <?php if ($images) { ?>
              ...
              foreach ($images as $key => $image) { ?>
                <a href="#" class="lightbox-link-10 lightbox-residencial-progresso w-inline-block w-lightbox"><img src="<?php echo $image['full_image_url']; ?>" loading="lazy" srcset="<?php echo $image['full_image_url']; ?> 500w, <?php echo $image['full_image_url']; ?> 800w, <?php echo $image['full_image_url']; ?> 1080w, <?php echo $image['full_image_url']; ?> 1600w, <?php echo $image['full_image_url']; ?> 2000w, <?php echo $image['full_image_url']; ?> 2600w, <?php echo $image['full_image_url']; ?> 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 500px" alt="" class="image-66 imagem-residencial-progresso">
                  <div class="imagem-ilustrativa"><em><?php echo $image['caption']; ?></em></div>
...
<div class="conceito">
  <div class="container-padrao">
    ...
    <div class="div-paragraph-center">
      <p class="paragraph-37">O Smart Urba é um jeito inteligente de viver, inspirado nos conceitos de <em>Smart City</em>, que buscam <strong class="bold-text-4">democratizar o acesso à tendência de morar no futuro </strong>com mais qualidade de vida. Em um bairro inteligente, você encontra tudo o que precisa para ser feliz.</p>
    </div>
    <style>
            ...
            <script>
              ...
              function initYouTubeVideos() {
                ...
                for (var n = 0; n < playerElements.length; n++) {
                  ...
                  thumbNode.src = 'https://urba.com.br/wp-content/uploads/2021/05/thumb-1.jpg'.replace(
                    'ID',
                    videoId
                  );
...
<!--<section id="videos" class="videos display-hidden">
  <div class="container-padrao">
    <h2 class="heading-27 center wire-branco"><strong class="destaque-h2-2 wire branco">Viva o seu sonho </strong>no Smart Urba</h2>
  </div>
</section>-->
<div class="features">
  <div class="container-padrao">
    <div class="div-features dunlop">
      ...
      <div data-w-id="f1a3f217-431e-773d-9779-2c846f450933" class="imagem-smarturba _7 dunlop-img"></div>
      <div class="div-info-smarturba dunlop">
        <h2 class="heading-27 tour-dunlop _2 _32px">Seja<strong class="destaque-h2-2"> mais feliz</strong></h2>
        <p class="paragraph-37">Ter um espaço que vai além do seu lote para descansar, correr, caminhar, <strong class="bold-text-4">espaço para realizar eventos ao ar livre</strong> e se divertir com a família é essencial para sua qualidade de vida.</p>
        <div data-w-id="c5fb3691-5e47-4678-c1a8-fd782d34a238" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-16.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Espaço de relaxamento</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-15.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Pista de caminhada</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-13.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Ciclofaixa e bicicletário</div>
          </div>
        </div>
        <div data-w-id="2d1b85f2-2c5b-0a11-93d6-f777c591a0ed" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-11.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Espaço fitness ao ar livre</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-14.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Skatepark</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-12.png" width="50" alt="" class="image-22">
            <div class="text-block-54">Wi-fi gratuito nas áreas de lazer</div>
          </div>
        </div>
        <div data-w-id="99e13e87-bce5-6d5e-df54-c0d9372809f4" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-10.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Playground inclusivo</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-09.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Espaço pet</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-17.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Pomar</div>
          </div>
        </div>
      </div>
    </div>
    <div class="div-features _2 dunlop-2">
      <div data-w-id="a73a88a8-b240-b5db-1442-077981fbc082" class="imagem-smarturba _6 dunlop-img"></div>
      <div class="div-info-smarturba _2 dunlop">
        <h2 class="heading-27 tour-dunlop _32px _2">Conviva em <strong class="destaque-h2-2">harmonia</strong></h2>
        <p class="paragraph-37">No Smart Urba Dunlop, você pode se integrar com todo o seu bairro, conviver em harmonia, ficar por dentro das novidades e ainda ter acesso a descontos exclusivos para comprar de produtores locais. Tudo isso é possível por meio de uma estrutura exclusiva da Urba para <strong class="bold-text-4">promover o seu bem-estar e dos demais moradores</strong>.</p>
        <div data-w-id="9c7a9543-1c0b-4587-8ab2-81f5c108dec6" class="topicos">
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Sede para futura Associação de Moradores</div>
          </div>
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Formação de um gestor social</div>
          </div>
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Aplicativo do bairro</div>
          </div>
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Promoção da harmonia e boa convivência</div>
          </div>
        </div>
      </div>
      <div data-w-id="91fe775c-840e-cd48-ad9d-270e5197954b" class="div-contorno _2"></div>
    </div>
  </div>
</div>
<div class="comercio">
  <div class="container-padrao">
    <div class="div-info-comercio">
      <div class="div-block-6">
        <h2 class="heading-27 com _32px branco"><strong class="destaque-h2 lime">Tenha praticidade</strong> no seu dia a dia</h2>
        <p class="paragraph-37 branco">Você quer estar próximo do comércio e ter o que precisa pertinho da sua casa, não é mesmo? Por isso, a Urba planejou, dentro do seu bairro inteligente, um espaço destinado a áreas comerciais e facilitou o <strong class="bold-text-4 lime">acesso aos serviços </strong>que deixam seu dia a dia mais cômodo, prático e tranquilo.</p>
        <p class="paragraph-37 branco">Você é<strong class="bold-text-4 lime"> Investidor ou Comerciante?</strong> Então, estar próximo do público, em uma região consolidada e com acesso às grandes avenidas, é fundamental. Quer saber, em primeira mão, de todos os detalhes sobre como você pode fazer parte do Smart Urba Dunlop e se aproximar de um <strong class="bold-text-4 lime">público potencial de mais de 4 mil pessoas</strong>?</p>
...
<div class="features _2">
  <div class="container-padrao">
    <div class="div-features dunlop">
      <div data-w-id="c097cd9e-e135-80f1-0fec-627b97058e3c" class="imagem-smarturba _2 dunlop-img"></div>
      <div class="div-info-smarturba dunlop">
        <h2 class="heading-27 tour-dunlop _2 _32px">Conecte-se<strong class="destaque-h2-2"> com a natureza</strong></h2>
        <p class="paragraph-37"><strong class="bold-text-4">Com mais de 52 mil m² de áreas verdes e revegetação de 14.8000 mudas</strong>, buscamos valorizar a fauna e a flora local. Assim, você pode aproveitar os espaços para ficar próximo da natureza, curtir a família e a tranquilidade de uma vida mais saudável, cercada por muito verde.</p>
        <div data-w-id="fcb147a1-851e-a9cb-de38-88896de60e4b" class="topicos">
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Áreas verdes e conservação do bioma local</div>
          </div>
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Vias arborizadas com espécies nativas</div>
          </div>
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Projeto paisagístico exuberante</div>
          </div>
          <div class="topico-2 dunlop-topic">
            <div class="text-block-55">Plantio de novas mudas</div>
          </div>
        </div>
      </div>
    ...
    <div class="div-features _2 dunlop-2">
      <div data-w-id="a2d98a21-2d06-a0d7-cec0-6378094c0006" class="imagem-smarturba dunlop-img"></div>
      <div class="div-info-smarturba _2 dunlop margin-top-off">
        <h2 class="heading-27 tour-dunlop _32px">Faça parte de um <strong class="destaque-h2-2">projeto sustentável</strong></h2>
        <p class="paragraph-37">Uma das maiores preocupações da Urba durante e após a construção de cada um dos seus empreendimentos é agir com <strong class="bold-text-4">responsabilidade socioambiental</strong>. Por isso, nossas obras prezam por ações que não prejudiquem o seu entorno e que ajudem a construir um mundo mais sustentável.</p>
        <div data-w-id="be020055-4156-f5fe-d760-6e56b01d3360" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-20.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Energia Fotovoltaica</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-19.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Recuperação de água pluvial</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-25.svg" width="50" alt="" class="image-22">
        ...
        <div data-w-id="66c4eb71-d8be-328c-3b77-bb6c57b2e737" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-21.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Uso de madeira certificada</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-22.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Plano de gestão de resíduos</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/Icons-24.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Compostagem de resíduos orgânicos<br></div>
          </div>
        </div>
      </div>
...
<div class="andamento-obra itapeva wf-section">
  <div class="container-padrao" style="text-align: center;">
    ...
    <p class="paragraph-16">Acompanhe por aqui o andamento da construção do loteamento <span class="text-span-6">Smart Urba Dunlop - Fase I</span> em detalhes<br></p>
    <div class="div-andamento">
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba40c-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="<?= get_stylesheet_directory_uri() ?>/images/icone-pag_empreendimentos-pavimentacao.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:50%;"></div>
        </div>
        <div class="text-block-12">Pavimentação<br><strong class="bold-text-3">50%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba40c-b3181021" class="div-etapa">
        ...
        <div class="text-block-12">Arrimo e Contenções<br><strong class="bold-text-3">99%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3f1-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/reflorestamento.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:80%;"></div>
        </div>
        <div class="text-block-12">Reflorestamento<br><strong class="bold-text-3">80%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/sinalizacao.png" width="60" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas areas-edificaveis" style="height:80%;"></div>
        </div>
        <div class="text-block-12">Sinalização<br><strong class="bold-text-3">80%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="<?= get_stylesheet_directory_uri() ?>/images/icons_paisagismo.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:74%;"></div>
        </div>
        <div class="text-block-12">Paisagismo<br><strong class="bold-text-3">74%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3e8-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/passeio-ciclovia.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:73%;"></div>
        </div>
        <div class="text-block-12">Passeio e Ciclovia<br><strong class="bold-text-3">73%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3fa-b3181021" class="div-etapa">
        ...
        <div class="text-block-12">Iluminação<br><strong class="bold-text-3">50%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/cercamento.png" width="58" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:50%;"></div>
        </div>
        <div class="text-block-12">Cercamento APP<br><strong class="bold-text-3">50%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
...
<div class="section-cta-2">
  <div class="container-padrao">
    <h2 class="heading-27 center white call">Gostou? Reserve seu lote no Smart Urba Dunlop!<br></h2>
...
<div class="visite wf-section">
  <div class="container-padrao-3 w-container">
    ...
    <a href="https://goo.gl/maps/PygbEG7DXkLodA5R9" target="_blank">Estrada Municipal Paz, 92 , Jardim Novo Maracanã | CEP: 13.058-005</a>
  </div>
</div>
<div class="texto-legal">
  <div class="container-padrao">
    <p class="paragraph-29">
      Este material tem caráter meramente ilustrativo por se tratar de bem a ser construído. As condições ora indicadas poderão sofrer alterações sem prévia comunicação ou anuência dos interessados, para adequação ao mercado. Contrato padrão e demais condições estão disponíveis em nosso plantão de vendas. Smart Urba Dunlop – Fase 1: Loteamento aprovado pela Prefeitura Municipal de Campinas através do Decreto Municipal de n° 21.310, de 8 de fevereiro de 2021, publicado em 09 de fevereiro de 2021. Registrado sob o n° 154052/R13 no 3º Oficial de Registro de Imóveis de Campinas, Estado de São Paulo. Smart Urba Dunlop – Fase 2: Loteamento aprovado com o registro de n° 63.200 do 3° Cartório Oficial de Registro de imóveis de Campinas, Estado de São Paulo. Plano de 144x direto com a loteadora com juros e corrigido pelo IPCA, ITBI e registro grátis somente para clientes com cadastros completos. Condições válidas somente para lotes residenciais.
    </p>
  </div>
</div>
  ...
  jQuery('#email-form').submit(function(e) {
    ...
    if (jQuery('#E-mail').val() && regex.test(jQuery('#E-mail').val()) && jQuery('#name').val() && jQuery('#Telefone').val() && jQuery('input[name=consentimento-de-comunicacao]:checked').length > 0) {
      var data_array = [{
        ...
        {
          name: 'identificador',
          value: "Interesse Smart Urba Dunlop"
