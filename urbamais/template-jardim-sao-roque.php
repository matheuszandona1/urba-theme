<?php
/*
Template Name: Jardim São Roque
*/
?>
<?php get_header(); ?>
<style>
...
<h1 style="display:none;">Terrenos em Boituva: Jardim São Roque - Bairro Planejado pela Urba</h1>
<div id="hero" class="hero-internas sao-roque wf-section">
  <div class="container-padrao reduzido montemor">
    <div class="div-info-hero monte-mor">
      <div class="columns-25 w-row">
        <div class="col-text monte-mor w-col w-col-7 w-col-stack w-col-small-small-stack">
          <p style="color: #fff;">Terrenos à venda em Boituva/SP</p>
          <div class="box itapeva montemor">
            <h2 class="heading-36 elvira-copy sao-roque"><strong>A Urba escolheu Boituva para você escolher qualidade de vida, todo dia.</strong><br></h2>
            <div class="div-box-preenchido-sao-roque"></div>
            <div class="div-box-contorno elvira"></div>
          </div>
          <h2 class="subtitle-lp monte-mor">More em um bairro planejado de lotes residenciais e mistos com lazer e acessibilidade, infraestrutura completa, área verde, comércio, serviços e muito mais!<br></h2>
        </div>
        <div class="col-forms w-col w-col-5 w-col-stack w-col-small-small-stack">
          <div class="div-forms-hero itapeva">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-5">
                <input type="hidden" id="idempreendimento" name="idempreendimento" value="21">
                ...
                <label for="E-mail-6" class="label-form-lp-2">E-mail</label>
                <input type="email" class="campo-form-lp-2 itapeva w-input" maxlength="256" name="email" data-name="email" placeholder="" id="email" required="">
                <label for="Telefone-4" class="label-form-lp-2 itapeva">WhatsApp</label>
                <input type="tel" class="campo-form-lp-2 itapeva w-input" minlength="15" maxlength="15" name="WhatsApp" data-name="WhatsApp" placeholder="" id="WhatsApp" onkeypress="MascaraTelefone(this);" required="">
                <label for="field" class="label-form-lp-2 itapeva">Tipo de lote:</label>
                <select id="tipo-de-lote" name="tipo-de-lote" data-name="tipo-de-lote" class="w-select">
                ...
                <div class="priv-monte-mor">Aceito receber via WhatsApp, ligação, e-mail e outras formas de contato da MRV&amp;CO, com ações de marketing, ofertas de produto e serviços. Estou de acordo com as formas de tratamento de dados realizados pela MRV&amp;CO, conforme a sua <a href="https://mrv.com.br/institucional/pt/politica-de-privacidade" target="_blank" class="link-10">Política de Privacidade</a>.</div>
                <div class="priv-check-monte-mor">
                  <label class="w-checkbox checkbox-field">
                    <input type="checkbox" id="politica-privacidade" name="consentimento-de-comunicacao" value="Ok, entendi!" data-name="consentimento-de-comunicacao" value="Ok, entendi!" required="" class="w-checkbox-input">
                    <span for="Ok-entendi" class="checkbox-label-2 w-form-label">Ok, entendi!</span>
                  </label>
                </div>
                <input type="submit" value="FALAR COM UM CONSULTOR" data-wait="Aguarde..." class="enviar-form-lp-2 botao-verde w-button">
              </form>
      ...
      <div class="div-logos-hero elvira"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/UB000322_BOITUVA_JARDIM-SAO-ROQUE_LOGO.png" width="160" alt="" class="logo-sao-roque"></div>
    </div>
  </div>
  <div class="tag-breve-lan-amento itapeva">
    <div class="text-block-47 montemor">Em obras</div>
  </div>
</div>
<div class="infos-terreno monte-mor infos-terreno-monte wf-section">
  <h2 class="heading-2 center sao-roque">A <span class="destaque-monte-mor"><strong class="bold-text-51">Urba escolheu Boituva </strong></span>para receber um novo conceito de bairro planejado</h2>
  <div class="container-padrao montemor">
    <p class="paragraph-16 montemor">Agora, você pode viver com muito mais tranquilidade no Jardim São Roque, um bairro planejado para oferecer o conforto que sua família merece — com <strong>infraestrutura completa e áreas de lazer</strong>.<br> Lotes à venda em Boituva/SP, residenciais e comerciais, para que você possa resolver tudo próximo de casa, para um dia a dia muito mais prático e com comodidade.<br></p>
    <div class="div-infos-terreno-sao-roque">
      <div data-w-id="2435a712-446a-235f-d2fe-115d8888aca6" style="opacity:0" class="topicos-sao-roque-02"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/planta_1.svg" width="130" alt="" class="icone-topicos">
        <div class="topicos-montemor">Lotes a partir de 140m²<br></div>
      </div>
      <div data-w-id="2435a712-446a-235f-d2fe-115d8888acab" style="opacity:0" class="topicos-sao-roque-02"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/mapa_1.svg" width="130" alt="" class="icone-topicos">
        <div class="topicos-montemor">Bairro planejado</div>
      </div>
      <div data-w-id="2435a712-446a-235f-d2fe-115d8888aca2" style="opacity:0" class="topicos-sao-roque-02"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/parque.svg" width="130" alt="" class="icone-topicos">
        <div class="topicos-montemor">Área verde</div>
      </div>
      <div data-w-id="02768a2c-985e-f3ea-a902-929b7b703f04" style="opacity:0" class="topicos-sao-roque-02"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/escola.svg" width="130" alt="" class="icone-topicos">
        <div class="topicos-montemor">Construção de escola no bairro</div>
      </div>
    </div>
  </div>
  <div class="div-button-center-sao-roque">
    <a href="#formulario" class="button-34 botao-sao-roque w-button"><strong>CLIQUE AQUI PARA SABER MAIS</strong></a>
  </div>
</div>
<div class="infos-terreno-sao-roque wf-section">
  <h2 class="heading-2 center">Compre seu lote no Jardim São Roque e viva com qualidade de vida!<span class="destaque-monte-mor-verde"></span></h2>
  <div class="container-padrao sao-roque">
    <div class="div-infos-terreno-sao-roque">
      <div data-w-id="2ed643f8-b740-ab62-c46b-571f3590e061" style="opacity:0" class="condicoes-sao-roque">
        <div class="topicos-sao-roque">Entrada facilitada</div>
      </div>
      <div data-w-id="2ed643f8-b740-ab62-c46b-571f3590e066" style="opacity:0" class="condicoes-sao-roque">
        <div class="topicos-sao-roque">
          <div class="topicos-sao-roque">Financiamento próprio sem burocracia</div>
        </div>
      </div>
      <div data-w-id="2ed643f8-b740-ab62-c46b-571f3590e06a" style="opacity:0" class="condicoes-sao-roque">
        <div class="topicos-sao-roque">Diversos planos de pagamento</div>
      </div>
    </div>
  </div>
  <div class="div-button-center-sao-roque">
    <a href="#formulario" class="button-34 botao-sao-roque w-button"><strong>GARANTA SEU NOVO ENDEREÇO</strong></a>
  </div>
</div>
<div class="cond-elvira cod">
  <div class="columns _2 w-row">
    <div class="column _2 interna elvira w-col w-col-4">
      <div class="text-block-4 _2 interna elvira">Financiamento direto com a loteadora</div>
    </div>
    <div class="column _2 interna elvira w-col w-col-4">
      <div class="text-block-4 _2 interna elvira">Parcelamento em 48x sem juros*</div>
    </div>
    <div class="column _2 interna end elvira w-col w-col-4">
      <div class="text-block-4 _2 interna elvira">ITBI e registro grátis</div>
    </div>
  </div>
  <div class="ipca">* Corrigido pelo IPCA</div>
...
<div class="infos-terreno monte-mor infos-terreno-monte wf-section">
  <div class="container-padrao sao-roque"></div>
  <div class="container-padrao montemor"></div>
  <div class="container-padrao">
    <h2 class="heading-27 center sao-roque-header">Seu novo endereço está esperando por você no <strong class="destaque-h2-laranja-2">Jardim São Roque</strong></h2>
    <p class="paragraph-44 regatas">O Jardim São Roque foi projetado para que você conquiste a qualidade de vida que sempre sonhou. E isso inclui uma ampla infraestrutura de urbanização, vias asfaltadas, espaços de lazer equipados, projeto paisagístico e uma área destinada à implantação de comércios e serviços de conveniência para a comunidade.<br></p>
    <div class="div-caracteristicas">
      <div data-w-id="0eea4538-8457-c56c-a8ee-3adb4e674dc0" style="opacity:0" class="div-caracteristica regatas">
        <div class="imagem-caracteristica-sao-roque sao-roque-img _1">
          <h3 class="heading-37">Infraestrutura</h3>
        </div>
        <p class="paragraph-44 regatas">Um bairro todo planejado, desenvolvido para que você more com muito mais <strong>qualidade de vida</strong> em Boituva/SP.Com infraestrutura completa, o Jardim São Roque conta com rede de água, luz e esgoto, vias asfaltadas e um projeto paisagístico incrível, no padrão <strong>Urba | MRV&amp;CO</strong>.<br></p>
      </div>
      <div data-w-id="071e8a36-d10f-58b3-2bf0-4e42cae0f09d" style="opacity:0" class="div-caracteristica regatas">
        <div class="imagem-caracteristica-sao-roque sao-roque-img _2">
          <h3 class="heading-37">LAZER</h3>
        </div>
        <p class="paragraph-44 regatas">No Jardim São Roque, você tem uma rotina com mais qualidade, que inclui estar perto de áreas verdes e lazer para todas as idades — quadra de areia, playground e academia ao ar livre.<br></p>
      </div>
      <div data-w-id="071e8a36-d10f-58b3-2bf0-4e42cae0f09d" style="opacity:0" class="div-caracteristica regatas">
        <div class="imagem-caracteristica-sao-roque sao-roque-img _3">
          <h3 class="heading-37">ESCOLA</h3>
        </div>
        <p class="paragraph-44 regatas">Morar bem é morar perto de tudo — e isso envolve a <strong>educação dos seus filhos</strong>.Por isso, o Jardim São Roque também conta com a <strong>construção de uma escola</strong>, garantindo um futuro bem melhor para as crianças.<br></p>
      </div>
      <div data-w-id="60183742-6cfd-4130-5297-600a9ac8f525" style="opacity:0" class="div-caracteristica regatas">
        <div class="imagem-caracteristica-sao-roque sao-roque-img _4">
          <h3 class="heading-37">área comercial</h3>
        </div>
        <p class="paragraph-44 regatas">Se você é comerciante, <strong>aproveite esta oportunidade</strong> e traga seu negócio para esta <strong>região promissora.</strong><br></p>
      </div>
    </div>
    <div class="div-block-17">
      <a href="#formulario" class="button-14 elvira w-button">SAIBA MAIS INFORMAÇÕES</a>
    </div>
  </div>
</div>
<div id="galeria" class="galeria-sao-roque wf-section">
  <div class="container-padrao-3 w-container">
    <p data-w-id="daf74de0-ded7-7623-7ec9-b27e0d686122" style="opacity:0" class="h1-2 verde-claro center">Explore o Jardim São Roque na galeria:</p>
      ...
      <div class="w-slider-mask">
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS.jpg" loading="lazy" srcset="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-500.jpg 500w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-800.jpg 800w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-1080.jpg 1080w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-1600.jpg 1600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-2000.jpg 2000w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-2600.jpg 2600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS-p-3200.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Área Residencial<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    ...
                    "fileSize": 3780757,
                    "height": 2531,
                    "url": "<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS.jpg",
                    "width": 4500,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1.jpg" loading="lazy" srcset="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-500.jpg 500w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-800.jpg 800w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-1080.jpg 1080w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-1600.jpg 1600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-2000.jpg 2000w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-2600.jpg 2600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1-p-3200.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Quadra de Areia<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "URBA_AREAS_COMUNS_QUADRA_AREIA_1.jpg",
                    "fileName": "URBA_AREAS_COMUNS_QUADRA_AREIA_1.jpg",
                    "fileSize": 3000680,
                    "height": 2531,
                    "url": "<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1.jpg",
                    "width": 4500,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS.jpg" loading="lazy" srcset="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-500.jpg 500w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-800.jpg 800w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-1080.jpg 1080w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-1600.jpg 1600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-2000.jpg 2000w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-2600.jpg 2600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS-p-3200.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Lotes Comerciais<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "URBA_RUA_LOJAS.jpg",
                    "fileName": "URBA_RUA_LOJAS.jpg",
                    "fileSize": 3688694,
                    "height": 2531,
                    "url": "<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS.jpg",
                    "width": 4500,
                    "type": "image"
                  }],
                  "group": "montemor"
        ...
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND.jpg" loading="lazy" srcset="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND-p-500.jpg 500w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND-p-800.jpg 800w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND-p-1080.jpg 1080w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND-p-1600.jpg 1600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Playground<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "URBA_AREAS_COMUNS_PLAYGROUND.jpg",
                    "fileName": "URBA_AREAS_COMUNS_PLAYGROUND.jpg",
                    "fileSize": 2347988,
                    "height": 1080,
                    "url": "<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_PLAYGROUND.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS.jpg" loading="lazy" srcset="<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS-p-500.jpg 500w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS-p-800.jpg 800w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS-p-1080.jpg 1080w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS-p-1600.jpg 1600w, <?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Academia ao ar livre<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "URBA_AREAS_COMUNS_FITNESS.jpg",
                    "fileName": "URBA_AREAS_COMUNS_FITNESS.jpg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_FITNESS.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg 500w, https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg 800w, https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg 1080w, https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg 1600w, https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Implantação Aérea 3D<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg",
                    "fileName": "URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_IMPLANTACAO_AEREA_3D_A2.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
...
<div class="localizacao wf-section">
  <div class="colunas-montemor w-row">
    <div class="column-27 w-col w-col-6 w-col-stack">
      <div class="coluna-1-monte-mor">
        <h2 class="heading-2 localiz sao-roque mobile"><strong>Loteamento em Boituva: </strong>Confira a localização privilegiada<br></h2>
        <p class="paragraph-16 localiz mobile">A região vai receber um bairro planejado com área comercial integrada, escola e muito mais, para que você tenha uma localização prática, com comodidade, segurança e mais qualidade de vida.<br></p>
        <div class="w-layout-grid grid-6">
          <div data-w-id="57a824d4-c990-baa5-105e-d513a67f9e4a" class="div-block-24"><img src="<?= get_stylesheet_directory_uri() ?>/images/montemor/6331d41f62a875b3cc076064_centro.svg" loading="lazy" alt="" class="image-5">
            <p class="paragrafo-2 topicos mobile"><span class="paragrafo-bold">7 minutos </span></br>do Centro</p>
          </div>
          <div data-w-id="57a824d4-c990-baa5-105e-d513a67f9e43" class="div-block-24"><img src="<?= get_stylesheet_directory_uri() ?>/images/montemor/6331ce4c4b0eadaa347a2b75_clock.svg" loading="lazy" alt="" class="image-5">
            <p class="paragrafo-2 topicos mobile"><span class="paragrafo-bold">20 minutos </span></br>de Cerquilo</p>
          </div>
          <div data-w-id="57a824d4-c990-baa5-105e-d513a67f9e51" class="div-block-24"><img src="<?= get_stylesheet_directory_uri() ?>/images/montemor/6331d4976968534821b5e65e_bus.svg" loading="lazy" alt="" class="image-5">
            <p class="paragrafo-2 topicos mobile"><span class="paragrafo-bold">Fácil acesso </span></br>à Castello Branco e demais rodovias <br> da região.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="w-tab-content">
          <div data-w-tab="Tab 1" class="tab-pane-tab-1 w-tab-pane w--tab-active">
            <div class="html-embed-2 w-embed w-iframe">
              ...
              <script src="https://maps.almav.com/maps/api/js?key=0e0b1139-6da6-49f2-8421-81d251fe0650&callback=initMap" async></script>
            </div>
          </div>
        </div>
      </div>
...
<div class="planta elvira wf-section">
  <div class="container-padrao monte-mor-mobile">
    <h2 class="heading-2 center">A <strong class="destaque-monte-mor-roxo">casa dos seus sonhos </strong>pode ser assim</h2>
    <div class="div-block-18 monte-mor">
      <div class="elvira-colunas monte-mor w-row">
            ...
            <script type="application/json" class="w-json">
              {
                "items": [{
                  ...
                  "fileSize": 1970155,
                  "height": 1080,
                  "url": "https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_CASA_MODELO_A3-1.jpg",
                  "width": 1920,
                  "type": "image"
                }],
                "group": ""
        ...
        <div class="column-30 monte-mor w-col w-col-3">
          <a href="#" data-w-id="2ba8ffd4-19cf-22a7-5f66-00feef640ffd" style="opacity:0" class="lightbox-link-8 w-inline-block w-lightbox">
            ...
            <script type="application/json" class="w-json">
              {
                "items": [{
                  ...
                  "fileSize": 1870603,
                  "height": 1080,
                  "url": "https://urba.com.br/wp-content/uploads/2022/12/URBA-Sao-Roque-Planta-2D-Casa-Modelo-Primeiro-Pavimento-2-2.jpg",
                  "width": 1920,
                  "type": "image"
                }],
                "group": ""
        ...
        <div class="column-31 monte-mor w-col w-col-3">
          <a href="#" data-w-id="f10deb40-e47e-664d-9493-467e1032fbee" style="opacity:0" class="lightbox-link-3 w-inline-block w-lightbox">
            ...
            <script type="application/json" class="w-json">
              {
                "items": [{
                  ...
                  "fileSize": 1736845,
                  "height": 1080,
                  "url": "https://urba.com.br/wp-content/uploads/2022/12/URBA-Sao-Roque-Planta-2D-Casa-Modelo-Segundo-Pavimento-2-1.jpg",
                  "width": 1920,
                  "type": "image"
                }],
                "group": ""
      ...
      <div class="div-block-23">
        <p class="paragraph-16">Fique à vontade para se inspirar com a sugestão de projeto que a Urba preparou para a sua futura casa em Boituva!<br></p>
        <div class="text-block-11 elvira">* Projeto não comercializado pela Urba</div>
        <a href="#formulario" class="button-34 botao-sao-roque mobile w-button"><strong>Gostou? Entre em contato e conquiste seu novo lar</strong></a>
      </div>
    </div>
  </div>
</div>
<div class="video-itapeva video-sao-roque wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 branco">Veja o que espera por você no Jardim São Roque:</h2>
    <div class="div-midia">
      <div style="padding-top:56.17021276595745%" class="w-embed-youtubevideo youtube"><iframe src="https://www.youtube.com/embed/tv3GK5ZKv_E?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameborder="0" style="position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:auto" allow="autoplay; encrypted-media" allowfullscreen="" title="Urba - Vamos além do m² do lote"></iframe></div>
    </div>
    <div class="div-button-center-sao-roque">
      <a href="#formulario" class="button-34 botao-sao-roque-2 w-button"><strong>Fale agora com a gente</strong></a>
    </div>
  </div>
</div>
<div class="andamento-obra elvira wf-section">
  <div class="container-padrao">
    ...
    <p class="paragraph-16">Acompanhe por aqui o andamento da construção do Jardim São Roque em detalhes, seu novo loteamento em Boituva/SP.<br></p>
    <div class="div-andamento">
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3fa-c81dfdf2" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icone-pag_empreendimentos-agua.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba3fd" class="div-evolucao agua-e-esgoto" style="height: 5%;"></div>
        </div>
        <div class="text-block-12">Rede de Água<br><strong class="bold-text-3">5%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3e8-c81dfdf2" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/pavimentacao.png" width="80" alt="" class="image-7">
          <div class="div-evolucao pavimentacao" style="opacity: 0;"></div>
        </div>
        <div class="text-block-12">Pavimentação<br><strong class="bold-text-3">0%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba403-c81dfdf2" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/iluminacao.png" width="80" alt="" class="image-7">
          <div class="div-evolucao eletrica" style="opacity: 0;"></div>
        </div>
        <div class="text-block-12">Rede Elétrica<br><strong class="bold-text-3">0%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba40c-c81dfdf2" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icone-pag_empreendimentos-sinalizacao.png" width="80" alt="" class="image-7">
          <div class="div-evolucao passeios-calcadas" style="opacity: 0;"></div>
        </div>
        <div class="text-block-12">Sinalização<br><strong class="bold-text-3">0%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3df-c81dfdf2" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icons_paisagismo.png" width="80" alt="" class="image-7">
          <div class="div-evolucao paisagismo" style="opacity: 0;"></div>
        </div>
...
<section id="formulario" class="formulario montemor wf-section">
  <div class="container-padrao monte-mor-form">
    <div class="div-forms interna regatas">
      <h2 class="heading-2 forms">Gostou? <strong class="destaque-monte-mor-roxo">Entre em contato conosco</strong></h2>
      <p class="paragraph-16"><span class="destaque-monte-mor-paragrafo"><strong>Fale com um consultor da Urba</strong></span><strong><br>‍</strong>Converse conosco e comece a planejar uma vida nova, com mais conforto, tranquilidade e qualidade. Tenha mais informações sobre os <strong class="destaque-monte-mor-paragrafo">lotes em Boituva/SP</strong>.<br></p>
      <div class="w-form">
        <form id="email-form-2" name="email-form-2" data-name="Email Form" method="get" class="form-2 form-monte-mor">
          <input type="hidden" id="idempreendimento" name="idempreendimento" value="21">
          <input type="text" class="text-field-2 w-input" maxlength="256" name="Nome-3" data-name="Nome-3" placeholder="Nome" id="Nome-3" required="">
          <div class="columns-9 w-row">
            <div class="column-69 w-col w-col-6">
              <input type="text" class="text-field-2 w-input" maxlength="256" name="E-mail-2" data-name="E-mail-2" placeholder="E-mail" id="E-mail-2" required="">
            </div>
            <div class="column-70 w-col w-col-6">
              <input type="tel" class="text-field-2 w-input" minlength="15" maxlength="15" name="WhatsApp-2" data-name="WhatsApp-2" placeholder="WhatsApp" id="WhatsApp-2" onkeypress="MascaraTelefone(this);" required="">
            </div>
          </div>
          <select id="tipo-de-lote" name="tipo-de-lote" data-name="tipo-de-lote" class="w-select">
            <option value="Residencial">Residencial</option>
          ...
          <div class="div-block-19 montemor">
            <p class="paragraph-16 montmor text-form">Aceito receber via WhatsApp, ligação, e-mail e SMS o contato da marca MRV&amp;CO com novidades sobre este loteamento, bem como outras ações de marketing, ofertas de produtos e serviços. Estou de acordo com as formas de tratamento de dados realizados pela MRV&amp;CO, conforme sua <a href="https://mrv.com.br/institucional/pt/politica-de-privacidade">POLÍTICA DE PRIVACIDADE</a>.<br></p><label class="w-checkbox checkbox-field-2 montemor">
              <label class="w-checkbox checkbox-field-2" style="width:140px;">
                <input type="checkbox" id="politica-privacidade" name="consentimento-de-comunicacao" value="Ok, entendi!" data-name="consentimento-de-comunicacao" value="Ok, entendi!" class="w-checkbox-input">
                <span class="checkbox-label-4 w-form-label" for="checkbox">Ok, entendi</span>
              </label>
          </div>
          <input type="submit" value="QUERO MAIS INFORMAÇÕES" data-wait="Aguarde..." class="button-34 botao-sao-roque w-button">
        </form>
        <!-- <div class="w-form-done">
            <div>Thank you! Your submission has been received!</div>
          </div>
...
<!-- <div class="visite wf-section">
  <div class="container-padrao-3 w-container">
    ...
    <a href="https://goo.gl/maps/C7qSPcvPiEp2p6Yz5" target="_blank"> Rua Guilherme Primo, nº 257 - Centro | Boituva/SP </a>
...
<div class="micro-rodape rodape-montemor wf-section">
  <div class="container-padrao w-container">
    <p class="paragraph-42 center"><em class="italic-text-3">Loteamento Jardim São Roque aprovado pela Prefeitura Municipal de Boituva através do termo de compromisso assinado entre a URBA 10 Loteamentos LTDA e a Prefeitura Municipal de Boituva no dia 15 de setembro de 2022, Certidão nº 242/2022, processo nº 9109/2022 aditado em 18 de outubro de 2022, Certidão nº 286/2022, Processo nº 16521/2022, registrado sob o nº R.6.M.14564, na matrícula 14.564 em 09 de dezembro de 2022 no Cartório de registro de Imóveis de Boituva.</em></p>
  </div>
</div>
<?php get_footer(); ?>
...
<script src="<?= get_stylesheet_directory_uri() ?>/js/webflow-saoroque.js" type="text/javascript"></script>
...
<script>
  jQuery('#email-form').submit(function(e) {
    ...
    if (jQuery('#email').val() && regex.test(jQuery('#email').val()) && jQuery('#name').val() && jQuery('#WhatsApp').val() && jQuery('input[name=consentimento-de-comunicacao]:checked').length > 0) {
      var data_array = [{
          name: 'loteamento',
          value: "Jardim São Roque"
        },
        {
          name: 'nome',
        ...
        {
          name: 'telefone',
          value: jQuery('#email-form #WhatsApp').val()
        },
        {
          name: 'email',
          value: jQuery('#email-form #email').val()
        },
        {
          name: 'tipo-de-lote',
          value: jQuery('#email-form #tipo-de-lote option:selected').val()
        },
        {
        ...
        {
          name: 'identificador',
          value: "Interesse Jardim São Roque"
...
<script>
  jQuery('#email-form-2').submit(function(e) {
    ...
    var regex = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
    if (jQuery('#E-mail-2').val() && regex.test(jQuery('#E-mail-2').val()) && jQuery('#Nome-3').val() && jQuery('#WhatsApp-2').val() && jQuery('input[name=consentimento-de-comunicacao]:checked').length > 0) {
      var data_array = [{
          name: 'loteamento',
          value: "Jardim São Roque"
        },
        {
          name: 'nome',
          value: jQuery('#email-form-2 #Nome-3').val()
        },
        {
          name: 'telefone',
          value: jQuery('#email-form-2 #WhatsApp-2').val()
        },
        {
          name: 'email',
        ...
        {
          name: 'tipo-de-lote',
          value: jQuery('#email-form-2 #tipo-de-lote option:selected').val()
        },
        {
          name: 'consentimento-de-comunicacao',
          value: 'granted'
