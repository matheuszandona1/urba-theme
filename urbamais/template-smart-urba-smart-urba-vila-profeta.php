<?php
/*
Template Name: Smart urba profeta
...
<style>
  ...
  .cta {
    height: 350px;
    background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.5)), to(rgba(0, 0, 0, 0.5))), url('../images/cta_5.jpg');
    background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../images/cta_5.jpg');
  ...
  .hero-internas.sao-roque {
    height: 800px;
    background-color: #fff;
    background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.2)), to(rgba(0, 0, 0, 0.2))), url('https://urba.com.br/wp-content/uploads/2022/11/father-holding-his-daughter-on-shoulders-and-laughing-1-min-1-scaled.jpg');
    background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url('https://urba.com.br/wp-content/uploads/2022/11/father-holding-his-daughter-on-shoulders-and-laughing-1-min-1-scaled.jpg');
    background-position: 0px 0px, 100% 50%;
    background-size: auto, cover;
    background-repeat: repeat, no-repeat;
  }
  ...
  .imagem-caracteristica._2.campos {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('../images/galeria-playground_1.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('../images/galeria-playground_1.jpg');
  }
  ...
  .div-img-casa.elvira {
    background-image: url('https://urba.com.br/wp-content/uploads/2022/12/URBA_SAO_ROQUE_CASA_MODELO_A3-1.jpg');
  }
  ...
  .div-planta-01 {
    width: 210px;
    height: 400px;
    background-image: url('<?= get_stylesheet_directory_uri() ?>/images/planta01.jpg');
    background-position: 50% 50%;
    background-size: cover;
    background-repeat: no-repeat;
    -webkit-transition: all 250ms ease-out;
  ...
  .div-planta-01.elvira {
    width: 260px;
    background-image: url('https://urba.com.br/wp-content/uploads/2022/12/URBA-Sao-Roque-Planta-2D-Casa-Modelo-Primeiro-Pavimento-2-2.jpg');
  }
  ...
  .div-planta-02.elvira {
    background-image: url('https://urba.com.br/wp-content/uploads/2022/12/URBA-Sao-Roque-Planta-2D-Casa-Modelo-Segundo-Pavimento-2-1.jpg');
  }
  ...
  .formulario.atlanta {
    background-image: url('../images/cta_6.jpg');
  ...
  .button-34.botao-sao-roque {
    ...
    border-radius: 5px;
    background-color: transparent;
    background-image: -webkit-gradient(linear, left top, right top, from(#e51d71), to(#d10b5f));
    background-image: linear-gradient(90deg, #e51d71, #d10b5f);
    text-align: center;
    text-transform: uppercase;
  ...
  .imagem-caracteristica-sao-roque.sao-roque-img {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/INFRAESTRUTURA.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/INFRAESTRUTURA.jpg');
  }

  .imagem-caracteristica-sao-roque.sao-roque-img._2 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/areaverde.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/areaverde.jpg');
    background-position: 0px 0px, 50% 50%;
  }

  .imagem-caracteristica-sao-roque.sao-roque-img._3 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/Escola - LP - Jardim São Roque.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/Escola - LP - Jardim São Roque.jpg');
    background-position: 0px 0px, 50% 0%;
    background-size: auto, cover;
  }

  .imagem-caracteristica-sao-roque.sao-roque-img._4 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/comercial.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/comercial.jpg');
  }

  .imagem-caracteristica-sao-roque.sao-roque-img._1 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_VISTA_RUA_CASAS.jpg');
  }

  .imagem-caracteristica-sao-roque.sao-roque-img._2 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_AREAS_COMUNS_QUADRA_AREIA_1.jpg');
  }
  ...
  .imagem-caracteristica-sao-roque.sao-roque-img._4 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/URBA_RUA_LOJAS.jpg');
  }

  .imagem-caracteristica-sao-roque.elvira {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/happy-father-teaching-his-cute-daughter-ride-bicycle-park.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/happy-father-teaching-his-cute-daughter-ride-bicycle-park.jpg');
  }

  .imagem-caracteristica-sao-roque.elvira._2 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/LAZER.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/LAZER.jpg');
    background-position: 0px 0px, 50% 50%;
  }

  .imagem-caracteristica-sao-roque.elvira._3 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/parents-their-daughter-are-holding-shopping-bags.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/parents-their-daughter-are-holding-shopping-bags.jpg');
    background-position: 0px 0px, 50% 0%;
    background-size: auto, cover;
  }
  ...
  .imagem-caracteristica-sao-roque.elvira._3 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/AREA-COMERCIAL_1.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/AREA-COMERCIAL_1.jpg');
    background-position: 0px 0px, 50% 0%;
    background-size: auto, cover;
  }
  ...
  .imagem-caracteristica-sao-roque.elvira._2 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/Área-de-Lazer---Imagem-meramente-ilustrativa---CORTADA.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/Área-de-Lazer---Imagem-meramente-ilustrativa---CORTADA.jpg');
  }
  ...
  @media screen and (max-width: 991px) {
    ...
    .hero-internas.sao-roque {
      height: 1223px;
      background-image: radial-gradient(circle farthest-corner at 60% 50%, transparent, rgba(0, 0, 0, 0.8)), -webkit-gradient(linear, left top, left bottom, from(transparent), to(transparent)), url('https://urba.com.br/wp-content/uploads/2022/11/father-holding-his-daughter-on-shoulders-and-laughing-1-min-1-scaled.jpg');
      background-image: radial-gradient(circle farthest-corner at 60% 50%, transparent, rgba(0, 0, 0, 0.8)), linear-gradient(180deg, transparent, transparent), url('https://urba.com.br/wp-content/uploads/2022/11/father-holding-his-daughter-on-shoulders-and-laughing-1-min-1-scaled.jpg');
      background-position: 0px 0px, 0px 0px, 28% 50%;
      background-size: auto, auto, cover;
    }
  ...
  @media screen and (max-width: 767px) {
    ...
    .hero-internas.sao-roque {
      height: 1210px;
      padding-top: 60px;
      background-image: radial-gradient(circle farthest-corner at 60% 50%, transparent, rgba(0, 0, 0, 0.8)), -webkit-gradient(linear, left top, left bottom, from(transparent), to(transparent)), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/father-holding-his-daughter-on-shoulders-and-laughing-1-min.jpg');
      background-image: radial-gradient(circle farthest-corner at 60% 50%, transparent, rgba(0, 0, 0, 0.8)), linear-gradient(180deg, transparent, transparent), url('<?= get_stylesheet_directory_uri() ?>/images/saoroque/father-holding-his-daughter-on-shoulders-and-laughing-1-min.jpg');
      background-position: 0px 0px, 0px 0px, 33% 50%;
    }
  ...
  @media screen and (max-width: 479px) {
    ...
    .cta {
      ...
      padding-top: 40px;
      padding-bottom: 40px;
      background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.4)), to(rgba(0, 0, 0, 0.4))), url('../images/cta_5.jpg');
      background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('../images/cta_5.jpg');
    ...
    .hero-internas.sao-roque {
      height: 100%;
      padding-bottom: 60px;
      background-image: url('https://urba.com.br/wp-content/uploads/2022/11/father-holding-his-daughter-on-shoulders-and-laughing-1-min-1-scaled.jpg');
      background-position: 50% 50%;
      background-size: cover;
      background-repeat: no-repeat;
      position: relative;
  ...
  @media screen and (max-width: 479px) {
    ...
    #w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3f1-e97534f8 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
  ...
  #hero-form .container-padrao.w-clearfix.dunlop {
  ...
  .hero-internas.dunlop {
    background-image: linear-gradient(270deg, rgba(0, 0, 0, 0.75), transparent 40%), linear-gradient(90deg, rgba(0, 0, 0, 0.75) 15%, hsla(0, 0%, 6%, 0) 50%), url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/hero-smart-urba-dunlop.jpg');
    background-position: 0px 0px, 100% 50%, 50% 0%;
    background-size: auto, auto, cover;
  }

  .imagem-smarturba._7.dunlop-img {
    background-image: url('https://urba.com.br/wp-content/uploads/2021/09/61535a5585ce857e18a5bbb8_Instagramavel.jpg');
  }

  .imagem-smarturba._6.dunlop-img {
    background-image: url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/associacao-moradores.jpg');
  }

  .img-comercio {
    background-image: url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/dobra-comercial.jpg');
  }

  .imagem-smarturba._2.dunlop-img {
    background-image: url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/5-praca-tranquilidade.jpg');
  }

  .imagem-smarturba.dunlop-img {
    background-image: url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/cruzamento.jpg');
  }
  ...
  @media screen and (max-width: 767px) {
    ...
    .hero-internas.dunlop {
      background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?= get_stylesheet_directory_uri() ?>/images/smart-urba-dunlop/hero-smart-urba-dunlop.jpg');
    }
  }
</style>
<section id="hero-form" class="hero-internas vila-profeta wf-section">

  <div class="container-padrao w-clearfix">
    <div class="div-text-hero smart-urba dunlop">
      <img src="https://urba.com.br/wp-content/uploads/2022/12/urba-selo-sucesso-vendas.png" alt="selo-sucesso-de-vendar" width="150" style="margin-bottom:20px;">
      <div class="div-logo-vila-profeta"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta.png" loading="lazy" width="300" sizes="(max-width: 479px) 100vw, (max-width: 991px) 230px, 300px" srcset="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta-p-500.png 500w, https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta-p-800.png 800w, https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta-p-1080.png 1080w, https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta-p-1600.png 1600w, https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta-p-2000.png 2000w, https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta-p-2600.png 2600w, https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Logo_Smart-Urba_Vila-Profeta.png 3855w" alt="" class="logo-vila-profeta"></div>
      <h1 class="h1-vila-profeta"><strong class="bold-text-48">Smart Urba <br>Vila Profeta:</strong> <br>um bairro inteligente <br>e seguro pensado <br>para você!</h1>
      <p class="paragraph-36 vila-profeta-subtitulo">Venha morar em um empreendimento tranquilo, acessível e inovador, onde cada detalhe é planejado para que você tenha mais <strong class="bold-text-49">qualidade de vida</strong>.<br></p>
      <div class="div-tags dunlop">
        <div>

          <div class="tag-hero-2 dunlop-box-hero vila-profeta-hero">Entrada facilitada</div>
          <div class="tag-hero-2 dunlop-box-hero vila-profeta-hero">Financiamento próprio sem burocracia</div>
          <div class="tag-hero-2 dunlop-box-hero vila-profeta-hero">Diversos planos de pagamento</div>
        </div>
      </div>
    </div>
    <div class="div-formulario-dunlop">
      <div class="div-forms-hero">
        <h3 class="heading-24 dunlop">Quero mais Informações</h3>
        <div class="w-form">
          <form id="email-form" name="email-form" data-name="Email Form" class="form-5">

            <label for="name" class="label-form-lp-2 vila-profeta">Nome</label><input type="text" class="campo-form-lp-2 w-input" maxlength="256" name="name" data-name="Name" placeholder="" id="name" required="">

            <label for="E-mail" class="label-form-lp-2 vila-profeta">E-mail</label><input type="email" class="campo-form-lp-2 w-input" maxlength="256" name="E-mail" data-name="E Mail" id="E-mail" required="">

            <label for="Telefone" class="label-form-lp-2 vila-profeta">Whatsapp</label><input type="text" class="telefone campo-form-lp-2 w-input" minlength="15" maxlength="15" name="Telefone" data-name="Telefone" id="Telefone" required="" onkeypress="MascaraTelefone(this);" />

            <div class="text-block-51 dunlop">Aceito receber via WhatsApp, ligação, e-mail e SMS, o contato da marca MRV&CO com novidades sobre este loteamento, bem como outras ações de marketing, ofertas de produtos e serviços. Estou de acordo com as formas de tratamento de dados realizados pela marca MRV&CO, conforme sua <a href="https://mrv.com.br/institucional/pt/politica-de-privacidade" target="_blank" class="link-10">Política de Privacidade</a>.</div>

            <div class="div-block-5"><label class="w-checkbox checkbox-field"><input type="checkbox" id="Ok, entendi!" name="Ok-entendi" data-name="Ok, entendi!" required="" class="w-checkbox-input"><span for="Ok, entendi!" class="checkbox-label-3 w-form-label">Ok, entendi!</span></label></div>

            <input type="submit" value="Enviar" data-wait="Aguarde..." class="enviar-form-lp-3 vila-profeta w-button">
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="tag-breve-lan-amento comercial dunlop">
    <div class="text-block-47 vila-profeta">Em obras</div>
  </div>
</section>
<div class="planejamento-inteligente wf-section">
  <div class="container-padrao">
    <h2 class="heading-27 center _32px"><strong class="destaque-h2-2">Infraestrutura planejada </strong>em cada detalhe</h2>
    <div class="columns-22 w-row">
      <div class="w-col w-col-4 w-col-stack">
        <p class="paragraph-37">O Smart Urba Vila Profeta conta com <span class="destaque-roxo"><strong>infraestrutura completa</strong></span> alinhada a recursos inteligentes que proporcionam bem-estar, conforto, segurança e praticidade ao seu dia a dia. <br><br>‍<span class="destaque-roxo"><strong>Planejado</strong></span> em uma região tranquila e arborizada de Campinas, o seu futuro endereço traz o que há de mais <span class="destaque-roxo"><strong>inovador</strong></span> em lazer e acessibilidade com tudo que você e sua família precisam para aproveitarem a vida com qualidade.<br></p>
      </div>
      <div class="w-col w-col-8 w-col-stack">
        <div data-w-id="b404bacf-4e4c-cff1-eb4c-ed98ca21ae02" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Ativo-3.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Lotes residenciais a partir de 126<span> </span>m²</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-01.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Vias pavimentadas</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-02.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Rede de energia</div>
          </div>
        </div>
        <div data-w-id="162a7fbd-a09f-bd0e-5e1e-e510ea80f8e1" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/icone-agua.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Rede de água e esgoto</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-04.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Áreas verdes </div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-17.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Projeto paisagístico</div>
          </div>
        </div>
        <div data-w-id="245d076c-2606-20c8-0ec1-a1ecf011d6e0" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-03.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Rampas acessíveis<br></div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-07.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Áreas de convivência e lazer para todas as idades</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-06.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Próximo a comércio e bens de serviço<br></div>
          </div>
        </div>
      </div>
    </div>
...
<div class="localizacao-dunlop wf-section">
  <div class="container-padrao">
    <h2 class="heading-27 center _32px">Conheça a localização<strong class="destaque-h2-2"> do seu futuro endereço</strong></h2>
    <div class="div-paragraph-center">
      <p class="paragraph-37">Localizado em Campinas, na região do Matão, ao lado do bairro Campo Florido, divisa com o município de Sumaré, o Smart Urba Vila Profeta é o destino de quem busca <span class="destaque-rosa"><strong>morar com tranquilidade e sossego</strong></span>, mas com a facilidade e a comodidade de quem busca <span class="destaque-rosa"><strong>estar próximo ao comércio e  a serviços essenciais do dia a dia</strong></span>. <br>‍<br>Residencial e silenciosa, a região é conhecida pela segurança, por suas belas praças e pela ótima localização.<br></p>
    </div>
    <div class="div-mapa-dunlop">
      ...
      <script src="https://maps.almav.com/maps/api/js?key=9e52ffaa-b0a2-4cc9-9420-6794e74f0543&callback=initMap" async></script>
    </div>
    <div class="div-button-center dunlop">
      <a href="#hero-form" class="button-12 smarturba _2 w-button">FALE AGORA COM UM CORRETOR</a>
...
<div class="andamento-obra itapeva wf-section">
  <div class="container-padrao" style="text-align: center;">
    <h2 class="heading-2 center"><strong class="destaque-h2-laranja vilaprofeta">Andamento</strong> da Obra</h2>
    ...
    <div class="div-andamento">
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3f1-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icone-pag_empreendimentos-drenagem.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba3fd" class="div-evolucao agua-e-esgoto" style="height:99%;"></div>
        </div>
        <div class="text-block-12">Rede de Drenagem<br><strong class="bold-text-3">99%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3f1-b3181021" class="div-etapa">
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3fa-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/iluminacao.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:99%;"></div>
        </div>
        <div class="text-block-12">Iluminação<br><strong class="bold-text-3">99%</strong></div>
      </div>
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3e8-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/passeio-ciclovia.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba40f" class="div-evolucao passeios-calcadas" style="height:66%;"></div>
        </div>
        <div class="text-block-12">Passeio e Ciclovia<br><strong class="bold-text-3">66%</strong></div>
      </div>
    ...
    <div class="div-lightbox-andamento">
      <a href="#" class="lightbox-link-6 w-inline-block w-lightbox">
        <div class="text-block-25" style="text-transform: none;">Confira as fotos da obra</div>
...
<div class="conceito wf-section">
  <div class="container-padrao">
    <h2 class="heading-27 center _32px">Entenda o conceito<strong class="destaque-h2-2"> Smart Urba</strong></h2>
    <div class="div-paragraph-center">
      <p class="paragrafo">O Smart Urba é um jeito inteligente de viver, inspirado nos conceitos de <em>Smart Cities</em>, que buscam <span class="text-span-2"><strong>democratizar o acesso à tendência de morar no futuro</strong></span><strong class="bold-text-4"> </strong>com mais qualidade de vida. Em um bairro inteligente, você encontra tudo o que precisa para ser feliz.</p>
    </div>
    <style>
      #video-conceito .owl-nav {
        display: flex;
        justify-content: center;
        align-items: center;
        color: #793f98;
      ...
      #video-conceito .owl-prev,
      #video-conceito .owl-next {
        font-size: 50px;
        margin-top: 20px;
      }

      #video-conceito .owl-prev span,
      #video-conceito .owl-next span {
        margin: 50px;
      }

      #video-conceito .w-embed {
        width: 720px;
        height: auto;
      }

      #video-conceito .div-video-2 {
        box-shadow: none;
      }

      #video-conceito .youtube-player {
        border-radius: 10px;
      }
    </style>
    <div class="owl-carousel" id="video-conceito">

      <div class="div-video-2">
        <div class="centraliza" style="display: flex; justify-content: center;">
          <div class="w-embed w-iframe w-script">
            <div class="youtube-player" data-id="GkoXg3-oBUc" style="background-image: url('https://urba.com.br/wp-content/uploads/2021/05/thumb-1.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
            <script>
              /*
            ...
            <style>
              ...
              .youtube-player .play {
                ...
                margin-top: -36px;
                position: absolute;
                background: url('<?php echo site_url(); ?>/wp-content/uploads/2023/09/youtube-placeholder.webp') no-repeat;
                cursor: pointer;
              }
            </style>
          </div>
    ...
    <div class="div-button-center dunlop">
      <a href="https://urba.com.br/smart-urba/" target="_blank" class="button-12 smarturba _2 w-button">GARANTA SEU NOVO ENDEREÇO</a>
      <a href="#" class="button-12 smarturba _2 mobile w-button">Desejo viver mais e melhor</a>
    </div>
  </div>
</div>
<div class="features wf-section">
  <div class="container-padrao">
    <div class="div-features dunlop">
      <div data-w-id="b0a64672-8088-0431-bfdf-5e934f706b53" class="div-contorno"></div>
      <div data-w-id="f1a3f217-431e-773d-9779-2c846f450933" class="imagem-smarturba _7 dunlop-img"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/smarturba-casinhas_1a.png" loading="lazy" width="200" style="opacity:0" data-w-id="f1a3f217-431e-773d-9779-2c846f450934" alt="" class="image-20 display-hidden"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/smarturba-casinhas_2b.png" loading="lazy" width="200" style="opacity:0" data-w-id="f1a3f217-431e-773d-9779-2c846f450935" alt="" class="image-21 display-hidden"></div>
      <div class="div-info-smarturba dunlop">
        <h2 class="heading-27 tour-dunlop _2 _32px">Seja<strong class="destaque-h2-2 vila-profeta"> mais feliz</strong></h2>
        <p class="paragraph-37">No Smart Urba Vila Profeta, o m² vai além do seu lote. Desfrute de <span class="destaque-rosa">espaços pensados para você e sua família</span> descansarem, se exercitarem, se divertirem e construírem memórias inesquecíveis.<br></p>
        <div data-w-id="c5fb3691-5e47-4678-c1a8-fd782d34a238" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/icone-bola.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Quadras gramadas<br></div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-15.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Pista de caminhada</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-09.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Pet place </div>
          </div>
        </div>
        <div data-w-id="478bf54e-58ab-1bc5-9a1c-c1a023676b10" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-16.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Espaço de relaxamento</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-14.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Skatepark</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-10.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Playground inclusivo</div>
          </div>
        </div>
        <div data-w-id="2d1b85f2-2c5b-0a11-93d6-f777c591a0ed" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-11.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Espaço fitness inclusivo</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/icone-instagram.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Espaço instagramável<br></div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-13.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Ciclovia<br></div>
          </div>
        </div>
      </div>
    </div>
    <div class="container-padrao">
      <div class="div-features _2 dunlop-2">
        <div data-w-id="a2d98a21-2d06-a0d7-cec0-6378094c0006" class="imagem-smarturba dunlop-img vila-profeta foto-2"><img src="https://urba.com.br/wp-content/uploads/2021/09/Parque-Linear_Fitness-1-1.jpg" loading="lazy" width="200" alt="" class="image-20 _4 display-hidden"></div>
        <div class="div-info-smarturba _2 dunlop margin-top-off">
          <h2 class="heading-27 tour-dunlop _32px">Conviva com<br>‍<strong class="destaque-h2-2 vila-profeta _3">harmonia</strong></h2>
          <p class="paragraph-37 _2">Convivência é tudo! Por meio de uma proposta inteligente de integração, a <strong>Urba auxilia na promoção do bem-estar e da harmonia</strong> entre os moradores do Smart Urba Vila Profeta. Através do aplicativo você ficará por dentro das novidades e de tudo que acontece no seu bairro.<br></p>
          <div data-w-id="be020055-4156-f5fe-d760-6e56b01d3360" class="div-grid-features _2">
            <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/uploads/2021/09/606f0400c6845954ba876096_Icons-08-svg.png" width="50" alt="" class="image-22">
              <div class="text-block-54">Associação de Moradores</div>
            </div>
            <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/uploads/2021/09/606f0a7a0b37500847fb19ed_Icons-23-svg.png" width="50" alt="" class="image-22">
              <div class="text-block-54">Formação de um gestor social</div>
            </div>
            <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/uploads/2021/09/606f0400c6845954ba876096_Icons-08-svg.png" width="50" alt="" class="image-22">
              <div class="text-block-54">Aplicativo do bairro</div>
            </div>
          </div>
        </div>
        <div data-w-id="ae633b8d-ae47-208f-d552-3cab211262fe" class="div-contorno _2 _3"></div>
      </div>
    </div>
  </div>
</div>
...
<div class="comercio wf-section">
  <div class="container-padrao">
    <div class="div-info-comercio">
      <div class="div-block-6">
        <h2 class="heading-27 com _32px branco"><strong class="destaque-h2 roxo">Tranquilidade <br>e praticidade</strong> <br>no seu dia a dia</h2>
        <p class="paragraph-37 branco">Viver com a comodidade de<span class="roxo bold"> ter tudo bem pertinho de casa</span> em um ambiente tranquilo e de muito ar puro: esse é um dos pilares do Smart Urba Vila Profeta.<br>‍<br>Além da praticidade que o comércio da região fornece, o empreendimento localiza-se também a 16 minutos do Shopping Dom Pedro e a 10 minutos da Rodovia Anhanguera para que você e sua família tenham ainda mais opções de serviços e fácil acesso à diversas localidades da região.<br></p>
        <a href="#hero-form" class="button-12 smarturba _2 w-button">SAIBA MAIS</a>
      </div>
    </div>
  </div>
  <div class="img-comercio"></div>
</div>
<div class="features _2 wf-section">
  <div class="container-padrao">
    <div class="div-features dunlop">
      <div data-w-id="c097cd9e-e135-80f1-0fec-627b97058e3c" class="imagem-smarturba _2 dunlop-img"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/smarturba-casinhas_2a---cópia.png" loading="lazy" width="200" style="opacity:0" data-w-id="c097cd9e-e135-80f1-0fec-627b97058e3d" alt="" class="image-20 _2 display-hidden"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/smarturba-casinhas_2b.png" loading="lazy" width="200" style="opacity:0" data-w-id="c097cd9e-e135-80f1-0fec-627b97058e3e" alt="" class="image-21 _2 display-hidden"></div>
      <div class="div-info-smarturba dunlop">
        <h2 class="heading-27 tour-dunlop _2 _32px">Conecte-se<strong class="destaque-h2-2"> <br>com a natureza</strong></h2>
        <p class="paragraph-37">Aproveite os<span class="destaque-rosa"> mais de 32 mil m² de áreas verdes</span> com <span class="destaque-rosa">mais de 5.000 mudas revegetadas</span> para estar próximo da natureza, curtir a família, praticar atividades ao ar livre ou passear com os bichos de estimação. Tudo isso em  um lugar tranquilo e visualmente interessante para relaxar, cercado por muito verde.<br></p>
        <div data-w-id="fcb147a1-851e-a9cb-de38-88896de60e4b" class="topicos">
          <div class="topico-2">
            <div class="text-block-55">Mais de 5 mil mudas revegetadas<br></div>
          </div>
          <div class="topico-2">
            <div class="text-block-55">Vias arborizadas<br></div>
          </div>
          <div class="topico-2">
            <div class="text-block-55">Projeto paisagístico exuberante<br></div>
          </div>
          <div class="topico-2">
            <div class="text-block-55">Mais de 32 mil m² de áreas verdes<br></div>
          </div>
        </div>
      </div>
      <div data-w-id="91e6aa81-ccd3-e317-9c4f-abc656dfbc2e" class="div-contorno _3"></div>
    </div>
    <div class="div-features _2 dunlop-2">
      <div data-w-id="a2d98a21-2d06-a0d7-cec0-6378094c0006" class="imagem-smarturba dunlop-img vila-profeta"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/smarturba-casinhas_1a.png" loading="lazy" width="200" alt="" class="image-20 _4 display-hidden"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/smarturba-casinhas_1b.png" loading="lazy" width="200" alt="" class="image-21 _5 display-hidden"></div>
      <div class="div-info-smarturba _2 dunlop margin-top-off">
        <h2 class="heading-27 tour-dunlop _32px">Faça parte de um <br>‍<strong class="destaque-h2-2 vila-profeta">projeto sustentável</strong></h2>
        <p class="paragraph-37">Uma das maiores preocupações da Urba durante e após a construção de cada um dos seus empreendimentos é agir com <strong class="destaque-rosa">responsabilidade socioambiental</strong>. Por isso, nossas obras prezam por ações que não prejudiquem o seu entorno e que ajudem a construir um mundo mais sustentável.</p>
        <div data-w-id="be020055-4156-f5fe-d760-6e56b01d3360" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-20.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Energia Fotovoltaica</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-19.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Reaproveitamento de água pluvial</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-25.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Uso de materiais regionais</div>
          </div>
        </div>
        <div data-w-id="66c4eb71-d8be-328c-3b77-bb6c57b2e737" class="div-grid-features _2">
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-21.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Uso de madeira certificada</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Icons-22.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Plano de gestão de resíduos</div>
          </div>
          <div class="div-feature _2 w-clearfix"><img src="https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/Ativo-4.svg" width="50" alt="" class="image-22">
            <div class="text-block-54">Compostagem de resíduos orgânicos</div>
          </div>
        </div>
      </div>
      <div data-w-id="ae633b8d-ae47-208f-d552-3cab211262fe" class="div-contorno _2 _3"></div>
...
<div id="galeria" class="galeria-sao-roque wf-section">
      ...
      <div class="w-slider-mask">
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 2000w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 2600w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Avenida Principal<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Avenida-Principal.jpg",
                    "fileName": "Avenida-Principal.jpg",
                    "fileSize": 3780757,
                    "height": 2531,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg",
                    "width": 4500,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 2000w, https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 2600w, https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Rotatória<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Rotatoria.jpg",
                    "fileName": "Rotatoria.jpg",
                    "fileSize": 3688694,
                    "height": 2531,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Rotatoria.jpg",
                    "width": 4500,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Vista aérea<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Vistas-aereas.jpg",
                    "fileName": "Vistas-aereas.jpg",
                    "fileSize": 2347988,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Vistas-aereas.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
        ...
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Parque da Felicidade<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Parque-Linear_Vista-Aerea.jpg",
                    "fileName": "Parque-Linear_Vista-Aerea.jpg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Vista-Aerea.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Espaço Fitness<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Parque-Linear_Fitness.jpg",
                    "fileName": "Parque-Linear_Fitness.jpg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Parque-Linear_Fitness.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Obstáculo skate<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Pista-de-Skate.jpg",
                    "fileName": "Pista-de-Skate.jpg",
                    "fileSize": 2347988,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Pista-de-Skate.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
        ...
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Sistema de lazer<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "SistemaLazer.jpg",
                    "fileName": "SistemaLazer.jpg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/SistemaLazer.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Escultura instagramável<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "Instagramavel.jpg",
                    "fileName": "Instagramavel.jpg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2021/12/Instagramavel.jpg",
                    "width": 1920,
                    "type": "image"
                  }],
                  "group": "montemor"
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"></a>
          </div>
        </div>
      </div>
    ...
    <div data-delay="4000" data-animation="slide" class="slider-7 mobile w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
      <div class="w-slider-mask">
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 500w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 800w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 2000w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 2600w, https://urba.com.br/wp-content/uploads/2021/12/Avenida-Principal.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Avenida Princiapl<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
...
<div class="section-cta-2 wf-section">
  <div class="container-padrao">
    <h2 class="heading-27 center white call">Gostou? Reserve seu lote no Smart Urba Vila Profeta!<br></h2>
    <div class="div-cta _2">
      <a href="#hero-form" class="button-12 smarturba _2 w-button">COMPRE SEU LOTE</a>
    </div>
  </div>
</div>
<div class="texto-legal wf-section">
  <div class="container-padrao">
    <p class="paragraph-29">Este material tem caráter meramente ilustrativo por se tratar de bem a ser construído. Contrato padrão e demais condições estão disponíveis em nosso plantão de vendas. As condições ora indicadas poderão sofrer alterações sem prévia comunicação ou anuência dos interessados, para adequação ao mercado. Loteamento aprovado pelo decreto nº 21.701, de 30 de setembro de 2021, publicado no Diário Oficial de Campinas no dia 01 de outubro de 2021, denominado Loteamento Residencial Vila Profeta, registrado na matrícula nº137.365, AV.6/137.365 do 2º Cartório de Registro de Imóveis de Campinas em 09 de dezembro de 2021, São Paulo – SP. Plano de 144x direto com a loteadora com juros e corrigido pelo IPCA.</p>
  </div>
</div>
...
<script>
  jQuery('#email-form').submit(function(e) {
    ...
    if (jQuery('#E-mail').val() && regex.test(jQuery('#E-mail').val()) && jQuery('#name').val() && jQuery('#Telefone').val()) {
      var data_array = [{
          name: 'loteamento',
          value: "Smart Urba Profeta"
        },
        {
          name: 'nome',
        ...
        {
          name: 'identificador',
          value: "Interesse Smart Urba Profeta"
        },
        {
...
<style>
  ...
  .hero-internas.vila-profeta {
    ...
    margin-top: 100px;
    padding-top: 0px;
    background-image: linear-gradient(114deg, #000, hsla(0, 0%, 100%, 0) 49%), linear-gradient(270deg, rgba(0, 0, 0, 0.5), transparent 26%), url('https://urba.com.br/wp-content/uploads/2021/11/30287DB6-3E32-4307-8E28-C85799B70179.jpeg');
    background-position: 0px 0px, 0px 0px, -1% 50%;
    background-size: auto, auto, cover;
    background-repeat: repeat, repeat, no-repeat;
    background-attachment: scroll, scroll, scroll;
  ...
  .imagem-caracteristica.regatas {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('../images/01.jpg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('../images/01.jpg');
  }
  ...
  .text-block-47.vila-profeta {
    background-image: linear-gradient(45deg, #7e3f9f, #7e3f9e, #7e3f9e);
  }
  ...
  .imagem-smarturba._2.dunlop-img {
    z-index: 2;
    width: 400px;
    background-image: url('https://urba.com.br/wp-content/uploads/2021/09/6123b2f96836de45bdd3896c_Parque-Linear_Vista-Aerea-1.jpg');
  }
  ...
  .imagem-smarturba.dunlop-img.vila-profeta {
    background-image: url('https://urba.com.br/wp-content/uploads/2021/09/61535c5afdcbeb63297935c9_Vistas-aereas.jpg');
  }


  .imagem-smarturba.dunlop-img.vila-profeta.foto-2 {
    background-image: url('<?= site_url(); ?>/wp-content/uploads/2021/12/Associacao-dos-Moradores-1-1.jpg');
  }
  ...
  .img-comercio {
    ...
    bottom: 0%;
    width: 50%;
    background-image: url('https://urba.com.br/wp-content/uploads/2021/09/61535b6d4fbbe6e5cc0c4b53_Rotatoria.jpg');
    background-position: 50% 50%;
    background-size: cover;
    background-repeat: no-repeat;
    background-attachment: scroll;
  ...
  @media screen and (max-width: 991px) {
    ...
    .hero-internas.vila-profeta {
      ...
      padding-top: 40px;
      padding-bottom: 40px;
      background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.5)), to(rgba(0, 0, 0, 0.5))), -webkit-gradient(linear, left top, left bottom, from(hsla(0, 0%, 96%, 0.03)), to(hsla(0, 0%, 96%, 0.03))), url('https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/bg-hero-vila-profeta.png');
      background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), linear-gradient(180deg, hsla(0, 0%, 96%, 0.03), hsla(0, 0%, 96%, 0.03)), url('https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/bg-hero-vila-profeta.png');
      background-position: 0px 0px, 0px 0px, 50% 50%;
      background-size: auto, auto, cover;
      background-repeat: repeat, repeat, no-repeat;
      background-attachment: scroll, scroll, scroll;
  ...
  @media screen and (max-width: 767px) {
    ...
    .hero-internas.vila-profeta {
      background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.6)), to(rgba(0, 0, 0, 0.6))), -webkit-gradient(linear, left top, left bottom, from(transparent), to(transparent)), url('https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/bg-hero-vila-profeta.png');
      background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), linear-gradient(180deg, transparent, transparent), url('https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/bg-hero-vila-profeta.png');
      background-position: 0px 0px, 0px 0px, 0% 50%;
    }
  ...
  @media screen and (max-width: 479px) {
    ...
    .hero-internas.vila-profeta {
      background-image: -webkit-gradient(linear, left top, left bottom, from(hsla(0, 0%, 94%, 0.03)), to(hsla(0, 0%, 94%, 0.03))), -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.64)), to(rgba(0, 0, 0, 0.64))), url('https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/bg-hero-vila-profeta.png'), -webkit-gradient(linear, left top, left bottom, from(transparent), to(transparent));
      background-image: linear-gradient(180deg, hsla(0, 0%, 94%, 0.03), hsla(0, 0%, 94%, 0.03)), linear-gradient(180deg, rgba(0, 0, 0, 0.64), rgba(0, 0, 0, 0.64)), url('https://urba.com.br/wp-content/themes/urbamais/images/urba-profeta/bg-hero-vila-profeta.png'), linear-gradient(180deg, transparent, transparent);
      background-position: 0px 0px, 0px 0px, 0% 50%, 0px 0px;
      background-size: auto, auto, cover, auto;
      background-repeat: repeat, repeat, no-repeat, repeat;
      background-attachment: scroll, scroll, scroll, scroll;
  ...
  #w-node-_214e244b-38e3-a924-7e1c-5d7a58811c00-531079c9 {
    -webkit-align-self: auto;
    -ms-flex-item-align: auto;
    -ms-grid-row-align: auto;
    align-self: auto;
  ...
  @media screen and (max-width: 479px) {
    #w-node-b44ff394-edce-04d3-2090-c80dbdc2c761-c488da31 {
      -ms-grid-column-align: center;
      justify-self: center;
      -webkit-align-self: center;
      -ms-flex-item-align: center;
    ...
    #w-node-_85a3680c-d7b6-e02a-6a0e-1dce1ffae6ac-c488da31 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-becaf4aa-22bf-6395-f491-196d89487d94-c488da31 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_33ff7a00-029d-371e-a001-fd257c06e2f2-c488da31 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-a078d2ae-fdf4-a339-e708-3c3663ec4719-c488da31 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_863f6c4e-0442-b4a0-dd15-ef53cf54d303-c488da31 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_0a78eb64-b467-5d9e-5e86-3b024f14cf8a-c488da31 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_8f8b3311-938b-542d-7468-eb2cfccb59c5-dc4099e1 {
      -ms-grid-column-span: 1;
      grid-column-end: span 1;
      -ms-grid-column: span 1;
      grid-column-start: span 1;
    ...
    #w-node-b44ff394-edce-04d3-2090-c80dbdc2c761-98b45796 {
      -ms-grid-column-align: center;
      justify-self: center;
      -webkit-align-self: center;
      -ms-flex-item-align: center;
    ...
    #w-node-_85a3680c-d7b6-e02a-6a0e-1dce1ffae6ac-98b45796 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-becaf4aa-22bf-6395-f491-196d89487d94-98b45796 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_33ff7a00-029d-371e-a001-fd257c06e2f2-98b45796 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-a078d2ae-fdf4-a339-e708-3c3663ec4719-98b45796 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_863f6c4e-0442-b4a0-dd15-ef53cf54d303-98b45796 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_0a78eb64-b467-5d9e-5e86-3b024f14cf8a-98b45796 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-b44ff394-edce-04d3-2090-c80dbdc2c761-0ef516d7 {
      -ms-grid-column-align: center;
      justify-self: center;
      -webkit-align-self: center;
      -ms-flex-item-align: center;
    ...
    #w-node-_85a3680c-d7b6-e02a-6a0e-1dce1ffae6ac-0ef516d7 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-becaf4aa-22bf-6395-f491-196d89487d94-0ef516d7 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_33ff7a00-029d-371e-a001-fd257c06e2f2-0ef516d7 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-a078d2ae-fdf4-a339-e708-3c3663ec4719-0ef516d7 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_863f6c4e-0442-b4a0-dd15-ef53cf54d303-0ef516d7 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
    ...
    #w-node-_0a78eb64-b467-5d9e-5e86-3b024f14cf8a-0ef516d7 {
      -webkit-align-self: center;
      -ms-flex-item-align: center;
      -ms-grid-row-align: center;
      align-self: center;
...
<script src="<?= get_template_directory_uri() ?>/owlcarousel/dist/owl.carousel.min.js"></script>
<script>
