<?php
/*
Template Name: Residencial Elvira
...
<style>
  ...
  .imagem-caracteristica-sao-roque.sao-roque-img {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url('https://urba.com.br/wp-content/uploads/2023/02/Elvira_Evolucao-das-Obras_Fev_23-6-scaled.jpeg');
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url('https://urba.com.br/wp-content/uploads/2023/02/Elvira_Evolucao-das-Obras_Fev_23-6-scaled.jpeg');
  }
  ...
  .formulario.giardino {
    background-image: url(<?= get_site_url() ?>/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA.jpg) !important;
  }
  ...
  .text-block-47.itapeva {
    background-image: linear-gradient(45deg, #7e3f9f, #7e3f9e, #7e3f9e) !important;
  }

  .div-box-contorno-2.itapeva {
    width: 370px;
    height: 185px;
  }
  ...
  .page-id-5794 .container-padrao.reduzido {
    max-width: 1000px;
    margin-top: -103px;
  }
  ...
  .hero-internas.itapeva {
    height: 800px;
    background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.2)), to(rgba(0, 0, 0, 0.2))), url(<?= get_site_url() ?>/wp-content/uploads/2022/02/620a4d4f178bbc46d9e1aa68_Depositphotos_158690232_L.jpg);
    background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(<?= get_site_url() ?>/wp-content/uploads/2022/02/620a4d4f178bbc46d9e1aa68_Depositphotos_158690232_L.jpg);
    background-position: 0px 0px, 50% 50%;
    background-size: auto, cover;
    background-repeat: repeat, repeat;
  }
  ...
  .imagem-caracteristica.regatas._3 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/area-comercial.jpeg);
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/area-comercial.jpeg);
    background-position: 0px 0px, 50% 0%;
    background-size: auto, cover;
  }

  .imagem-caracteristica.regatas._2 {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/lazer_nova_imagem.jpg);
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/lazer_nova_imagem.jpg);
    background-position: 0px 0px, 50% 50%;
  }

  .imagem-caracteristica.regatas {
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(46%, transparent), to(rgba(0, 0, 0, 0.5))), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/Infraestrutura.jpeg);
    background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/Infraestrutura.jpeg);
  }

  .formulario.giardino {
    background-image: url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/Infraestrutura.jpe
 g);
  }
</style>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WRN3MGR" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navbar w-nav">
  <div class="container-padrao">
    <a href="https://urba.com.br/" class="brand w-nav-brand"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/urba-logo.png" width="150" alt=""></a>
    <nav role="navigation" class="nav-menu w-nav-menu">
      <a href="https://urba.com.br/" class="nav-link w-nav-link">Home</a>
      <a href="https://urba.com.br/smart-urba/" class="nav-link w-nav-link">Loteamentos</a>
      <a href="https://urba.com.br/loteadora/" class="nav-link w-nav-link">Conheça a Urba</a>
      <a href="https://urba.com.br/minha-casa-do-meu-jeito/" class="nav-link w-nav-link">Modalidades</a>
      <a href="https://urba.com.br/blog/" class="nav-link w-nav-link">Blog</a>
      <a href="https://urba.com.br/ri/" class="nav-link w-nav-link">Investidores</a>
      <a href="https://urba.com.br/area-do-cliente-urba/" class="nav-link w-nav-link">Área do Cliente</a>
    </nav>
...
<div id="hero" class="hero-internas itapeva wf-section">
  <div class="container-padrao reduzido">
    <div class="div-logos-hero itapeva"><img src="<?= get_site_url() ?>/wp-content/uploads/2022/02/61fa85554dd6508fc30265c8_Logo_Elvira_-_crop-removebg-preview.png" width="160" alt="" class="logo-elvira"></div>
    <div class="div-info-hero">
      <div class="w-row">
        <div class="col-text w-col w-col-7">
          <div class="box itapeva">
            <h1 class="heading-36">Terrenos em Uberaba, para você construir seu sonho e <span class="text-span-3">viver a sua melhor fase</span><br><br></h1>
            <div class="div-box-preenchido-itapeva-2"></div>
            <div class="div-box-contorno-2 itapeva"></div>
          </div>
          <h2 class="subtitle-lp itapeva">More em um bairro planejado com lazer e acessibilidade, infraestrutura completa, área verde, comércio, serviços e muito mais!<br></h2>

        </div>
        <div class="col-forms w-col w-col-5">
          <div class="div-forms-hero itapeva">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" class="form-5">
                <input type="hidden" id="idempreendimento" name="idempreendimento" value="19">
                ...
                <label for="Telefone" class="label-form-lp-2 itapeva">WhatsApp</label><input type="tel" class="campo-form-lp-2 itapeva w-input" minlength="15" maxlength="15" name="Telefone" data-name="Telefone" onkeypress="MascaraTelefone(this);" placeholder="" id="Telefone" required="">
                <label for="field" class="label-form-lp-2 itapeva">Tipo de lote</label>
                <div class="w-embed">
                  <style>
                    #Menu-suspenso {
                      color: #ffffff;
                ...
                </div><select id="Menu-suspenso" name="Menu-suspenso" data-name="Menu suspenso" class="campo-form-lp-2 itapeva w-select">
                  <option value="Selecione">Selecione...</option>
                  <option value="first">Lotes residenciais</option>
                  <option value="second">Lotes comerciais</option>
                </select>
                <div class="text-block-44">Aceito receber via WhatsApp, ligação, e-mail e SMS, o contato da marca MRV&CO com novidades sobre este loteamento, bem como outras ações de marketing, ofertas de produto e serviços. Estou de acordo com as formas de tratamento de dados realizados pela marca MRV&CO, conforme sua <a href="https://www.mrv.com.br/institucional/pt/politica-de-privacidade" target="_blank" class="link-10">Política de Privacidade</a>.</div>
                <div class="div-block-5"><label class="w-checkbox checkbox-field">

                    <input type="checkbox" id="politica-privacidade" name="consentimento-de-comunicacao" value="Ok, entendi!" data-name="Ok, entendi!" required="" class="w-checkbox-input"><span for="Ok-entendi" class="checkbox-label-2 w-form-label">Ok, entendi!</span></label></div><input type="submit" value="FALE COM UM CONSULTOR" data-wait="Aguarde..." class="enviar-form-lp-2 itapeva w-button">
              </form>
  ...
  <div class="tag-breve-lan-amento itapeva">
    <div class="text-block-47 itapeva">EM OBRAS</div>
  </div>
</div>
<div class="infos-terreno wf-section">
  <h2 class="heading-2 center">A <strong class="destaque-h2-elvira">Urba escolheu Uberaba</strong> para receber seu <strong class="destaque-h2-elvira">primeiro empreendimento em Minas Gerais</strong></h2>
  <div class="container-padrao">

    <p class="paragraph-16 itapeva">Agora, você pode viver com muito mais tranquilidade no Residencial Elvira, um bairro planejado para oferecer o conforto que sua família merece — com <strong class="destaque-verde">infraestrutura completa e áreas de lazer</strong>.<br><br>Terrenos em Uberaba/MG, residenciais e comerciais, para que você possa resolver tudo próximo de casa, para um dia a dia muito mais prático e com comodidade.<br></p>
    <div class="div-infos-terreno">
      <div data-w-id="5b2e0ec8-6296-3122-3294-a25915ec3bb0" class="div-info-terreno"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icone-pag-empreendimentos-terrenos.png" width="130" alt="" class="image-4">
        <div class="text-block-8">Terrenos a partir de 250m²<br></div>
      </div>
      <div data-w-id="4a19bfba-b099-a58b-e082-bfaf50dccdf2" class="div-info-terreno end-mobile"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icone-pag-empreendimentos-bairro-condominio.png" width="130" alt="" class="image-4">
        <div class="text-block-8">Bairro planejado</div>
      </div>
      <div data-w-id="45bedf70-5e9e-57cf-dcb3-a650222eb2a2" class="div-info-terreno"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icons_verde_1.png" width="130" alt="" class="image-4">
        <div class="text-block-8">Qualidade ambiental<br></div>
      </div>
      <div data-w-id="f1192464-aabc-97e5-e8a8-87e07178f88d" class="div-info-terreno end"><img src="https://urba.com.br/wp-content/uploads/2022/12/construction-2-1.png" width="130" alt="" class="image-4">
        <div class="text-block-8">Obras aceleradas</div>
      </div>
    </div>
    <div class="div-text-terreno cond" style="margin-top: 45px;">
      <p class="paragraph-16 itapeva" style="margin-bottom:70px;">Terrenos à venda em Uberaba/MG com condições especiais de lançamento</p>
      <div class="columns itapeva w-row">
        <div class="column _2 interna w-col w-col-4">
          <div class="text-block-4 _2 interna">Entrada facilitada</div>
        </div>
        <div class="column _2 interna w-col w-col-4">
          <div class="text-block-4 _2 interna">Financiamento próprio sem burocracia</div>
        </div>
        <div class="column _2 interna end w-col w-col-4">
          <div class="text-block-4 _2 interna">Diversos planos de pagamento</div>
        </div>
      </div>
      <!--<p class="paragraph-16 itapeva ipca" style="display:block;margin-top:-30px;">*parcelas corrigidas pelo IPCA<br></p>-->
      <a href="#formulario" class="button-34 itapeva w-button">GARANTA SEU NOVO ENDEREÇo</a>
      <!--<p class="paragraph-16 itapeva" style="margin-top:30px;"><strong style="font-weight: 800;font-size: 30px;color: #7C3F9C;">Evento de Lançamento</strong></p>
       <p class="paragraph-16 itapeva" style="font-weight:500;font-size:18px;">
       	 Dias: <strong style="font-weight: 800;">24</strong> e <strong style="font-weight: 800;">25</strong> de junho</br></p>
	   	<p class="paragraph-16 itapeva" >Local: Parque de Exposição Fernando Costa na Tatersal da ABCZ</br>
		(Associação Brasileira de Criação de Zebu)</p>-->

    </div>
  </div>
</div>
<div class="caracteristicas wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 center">Seu novo endereço está esperando por você no <strong class="destaque-h2-laranja">Residencial Elvira</strong></h2>
    <div class="div-caracteristicas">
      <div data-w-id="86641039-24a1-7300-0730-6636ef260df0" class="div-caracteristica regatas">
        <div class="imagem-caracteristica regatas">
          <h3 class="heading-7">Infraestrutura</h3>
        </div>
        <p class="paragraph-17 regatas">Um bairro todo planejado, desenvolvido para que você more com muito mais <span class="destaque-laranja">qualidade de vida</span> na melhor região de Uberaba. <br><br>Com infraestrutura completa, o Residencial Elvira conta com rede de água, luz e esgoto, vias asfaltadas e um projeto paisagístico incrível, no padrão <span class="destaque-laranja">Urba | MRV&amp;CO</span>.<br><br>São 298.711m² com 635 lotes (455 unidades residenciais, 87 unidades comerciais e 93 unidades mistas).<br></p>
      </div>
      <div data-w-id="58f694a6-e2ea-5a2d-81ce-444659efc478" class="div-caracteristica regatas">
        <div class="imagem-caracteristica regatas _2">
          <h3 class="heading-7">Lazer</h3>
        </div>
        <p class="paragraph-17 regatas">Viver momentos especiais em família. É isso que toda a área de convivência proporciona, com <span class="destaque-laranja">playground </span>para as crianças, <span class="destaque-laranja">espaço fitness</span> para se exercitar, <span class="destaque-laranja">quadra de areia</span> para quem gosta de praticar esportes e <span class="destaque-laranja">pet place</span> para se divertir com seu bichinho.<br><br>Além disso, o bairro conta com mais de 30mil m² de <span class="destaque-laranja">áreas verdes</span>, tornando o seu dia a dia mais próximo da natureza.</p>
      </div>
      <div data-w-id="58f694a6-e2ea-5a2d-81ce-444659efc478" class="div-caracteristica regatas">
        <div class="imagem-caracteristica-sao-roque sao-roque-img _10">
          <h3 class="heading-7">Obras aceleradas</h3>
        </div>
        <p class="paragraph-17 regatas">Você não precisa esperar mais para garantir a qualidade de vida que o seu futuro merece! O Residencial Elvira está com <span class="destaque-laranja">obras em fase final</span>, para que você receba seu lote em curto prazo e possa construir a casa dos seus sonhos mais breve do que imagina, tudo isso com a qualidade Urba. <br><br>O seu melhor futuro começa agora!</p>
      </div>
      <div data-w-id="48b6015e-7755-3c2e-600a-aca4e030d055" class="div-caracteristica regatas">
        <div class="imagem-caracteristica regatas _3">
          <h3 class="heading-7">área comercial</h3>
        </div>
        <p class="paragraph-17 regatas">Para uma rotina com mais <span class="destaque-laranja">praticidade</span>, preparamos ainda uma área integrada de <span class="destaque-laranja">lotes comerciais</span> bem pertinho de casa, para acesso rápido a bens e serviços.<br><br>Se você é <span class="destaque-laranja">comerciante</span>, aproveite esta oportunidade em um bairro com potencial para <span class="destaque-laranja">mais de 1900 moradores</span> e tenha o seu negócio em uma região promissora de Uberaba.<br></p>
        <div class="div-block-16">
          <a href="#hero" class="button-33 elvira w-button">CLIQUE AQUI E SAIBA MAIS</a>
        </div>
      </div>
    </div>
    <div class="div-block-17">
      <a href="#formulario" class="button-34 elvira w-button">SAIBA MAIS INFORMAÇÕES</a>
    </div>
  </div>
</div>
...
<div class="andamento-obra itapeva wf-section">
  <div class="container-padrao" style="text-align: center;">
    ...
    <div class="div-andamento">
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/iluminacao.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba418" class="div-evolucao areas-edificaveis" style="height:77%;"></div>
        </div>
        <div class="text-block-12">Iluminação<br><strong class="bold-text-3">77%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3df-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/pavimentacao.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba3e2" class="div-evolucao paisagismo" style="height:97%;"></div>
        </div>
        <div class="text-block-12">Pavimentação<br><strong class="bold-text-3">97%</strong></div>
      </div>
      <!-- <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3e8-b3181021" class="div-etapa">
        ...
        <div class="text-block-12">Sinalização<br><strong class="bold-text-3">45%</strong></div>
      </div> -->
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba40c-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icons_paisagismo.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba418" class="div-evolucao paisagismo-progresso" style="height:61%;"></div>
        </div>
        <div class="text-block-12">Paisagismo<br><strong class="bold-text-3">61%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba40c-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2023/01/area-lazer.png" width="60" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba418" class="div-evolucao paisagismo-progresso" style="height:80%;"></div>
        </div>
        <div class="text-block-12">Área de lazer<br><strong class="bold-text-3">80%</strong></div>
      </div>
    </div>
    ...
    <div class="div-lightbox-andamento">
      ...
      <a href="#" class="lightbox-link-6 w-inline-block w-lightbox" aria-label="open lightbox" aria-haspopup="dialog">
      ...
      <div class="w-slider-mask">
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 500w, https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 800w, https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 1080w, https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 1600w, https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 2000w, https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 2600w, https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Imagem aérea<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg",
                    "fileName": "61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg",
                    "fileSize": 3780757,
                    "height": 2531,
                    "url": "https://urba.com.br/wp-content/uploads/2022/02/61fabb8ff4cdc3b81e53d21c_Vistas-aereas-1-p-1080.jpg",
                    "width": 4500,
                    "caption": "Imagem aérea",
                    "type": "image"
                  }],
                  "group": "montemor"
                }
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 500w, https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 800w, https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 1080w, https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 1600w, https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 2000w, https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 2600w, https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Área comercial<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg",
                    "fileName": "61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg",
                    "fileSize": 3688694,
                    "height": 2531,
                    "url": "https://urba.com.br/wp-content/uploads/2022/02/61fabc2514a0116679b0b7c2_AREA-COMERCIAL-p-1080.jpeg",
                    "width": 4500,
                    "caption": "Área comercial",
                    "type": "image"
                  }],
                  "group": "montemor"
                }
            ...
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg 500w, https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg 800w, https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg 1080w, https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg 1600w, https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Playground<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg",
                    "fileName": "61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg",
                    "fileSize": 2347988,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg",
                    "width": 1920,
                    "caption": "Playground",
                    "type": "image"
                  }],
        ...
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg 500w, https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg 800w, https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg 1080w, https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg 1600w, https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg 1920w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 380px" alt="" class="image-66">
              <p class="galeria-monte"><span class="galeria-bold">Rua interna<br></span>Imagem meramente ilustrativa</p>
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "_id": "example_img",
                    "origFileName": "61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg",
                    "fileName": "61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg",
                    "fileSize": 2472137,
                    "height": 1080,
                    "url": "https://urba.com.br/wp-content/uploads/2022/02/61fabc254011ee1e73dfa37d_INFRAESTRUTURA-p-1600.jpeg",
                    "width": 1920,
                    "caption": "Rua interna",
                    "type": "image"
                  }],
...
<div class="localizacao wf-section">
  <div class="columns-6 w-row">
    <div class="column-27 w-col w-col-5">
      <div class="div-title-info-localizacao">
        <h2 class="heading-2 localiz elvira">Localização <strong>privilegiada </strong>para morar em Uberaba/MG<br></h2>
        <p class="paragraph-16 localiz">O Residencial Elvira conta com uma <span class="destaque-verde-escuro">ótima localização</span>, na <span class="destaque-verde-escuro">Zona Sul de Uberaba</span>, próximo à Av. Tonico dos Santos, aos principais condomínios da região e com fácil acesso ao Centro. Você e sua família estarão bem próximos dos bairros Jardim Maracanã e Recreio dos Bandeirantes, às margens da Av. Geraldo Formiga do Nascimento.<br></p>
      </div>
    </div>
        ...
        <div class="w-tab-content">
          <div data-w-tab="Tab 1" class="tab-pane-tab-1 w-tab-pane w--tab-active">
            <div class="html-embed-2 w-embed w-iframe">
              ...
              <script src="https://maps.almav.com/maps/api/js?key=bd1166c1-a177-469d-86c6-48de793dcb2a&callback=initMap" async></script>
              <!--<iframe src="https://urba.almav.com.br/residencialelvira/" width="100%" height="680px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>-->
            </div>
          </div>
          <!--<div data-w-tab="Tab 2" class="tab-pane-tab-2 w-tab-pane">
              <a href="#" class="lightbox-link-2 w-inline-block w-lightbox"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/SQUAD_URBA_RESERVA_PRIME_PSD_MASTERPLAN_GOOGLE_R08.jpg" alt="" class="image-6">
                <script type="application/json" class="w-json">{
  "items": [
    {
      "width": 1920,
      "caption": "",
      "height": 1358,
      "fileName": "SQUAD_URBA_RESERVA_PRIME_PSD_MASTERPLAN_GOOGLE_R08.jpg",
      "origFileName": "SQUAD_URBA_RESERVA_PRIME_PSD_MASTERPLAN_GOOGLE_R08.jpg",
      "url": "images/SQUAD_URBA_RESERVA_PRIME_PSD_MASTERPLAN_GOOGLE_R08.jpg",
      "_id": "5f626b2275c6e69f8f6115e4",
      "type": "image",
      "fileSize": 642510
    }
  ]
...
<div class="planta itapeva wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 center">A sua <strong class="destaque-h2-laranja">casa dos sonhos </strong>pode ser assim</h2>
    <p class="paragraph-16">Fique à vontade para se inspirar com a sugestão de projeto que a Urba preparou para a sua futura casa em Uberaba!<br></p>
    ...
    <div class="columns-7 w-row">
      <div class="column-29 w-col w-col-8">
        <a href="#" data-w-id="c426b8fb-a8ab-f5fd-14fc-4df463ae0ee1" class="lightbox-link-4 w-inline-block w-lightbox">
          <div class="div-img-casa regatas" style="background-image:url(<?= get_site_url() ?>/wp-content/uploads/2022/02/61fac5904011ee6ecbdff5ad_Fachada.jpg);"></div>
          <script type="application/json" class="w-json">
            {
              "items": [{
                "width": 1422,
                ...
                "height": 800,
                "fileName": "1fac5904011ee6ecbdff5ad_Fachada.jpg",
                "origFileName": "1fac5904011ee6ecbdff5ad_Fachada.jpg",
                "url": "<?= get_site_url() ?>/wp-content/uploads/2022/02/61fac5904011ee6ecbdff5ad_Fachada.jpg)",
                "_id": "5577",
                "type": "image",
                "fileSize": 307821
              }]
      ...
      <div class="column-30 w-col w-col-2">
        <a href="#" data-w-id="2ba8ffd4-19cf-22a7-5f66-00feef640ffd" class="lightbox-link-3 w-inline-block w-lightbox">
          <div class="div-planta-01 regatas" style="background-image:url(<?= get_site_url() ?>/wp-content/uploads/2022/02/61fac59014a0113e66b0ff13_Planta-Humanizada_FirstFloor.jpg);"></div>
          <script type="application/json" class="w-json">
            {
              "items": [{
                "width": 2500,
                "caption": "Imagem meramente ilustrativa",
                "height": 1042,
                "fileName": "61fac59014a0113e66b0ff13_Planta-Humanizada_FirstFloor.jpg",
                "origFileName": "61fac59014a0113e66b0ff13_Planta-Humanizada_FirstFloor.jpg",
                "url": "<?= get_site_url() ?>/wp-content/uploads/2022/02/61fac59014a0113e66b0ff13_Planta-Humanizada_FirstFloor.jpg)",
                "_id": "5f625e24e01f999db2245d77",
                "type": "image",
                "fileSize": 306071
              }]
            }
      ...
      <div class="column-31 w-col w-col-2">
        <a href="#" data-w-id="15041d83-fed3-e9e7-68c3-6a3f2bf2b2b6" class="lightbox-link-5 w-inline-block w-lightbox">
          <div class="div-planta-02 regatas" style="background-image:url(<?= get_site_url() ?>/wp-content/uploads/2022/02/61fac58fc5ed659b4a8016f1_Planta-Humanizada_SecondFloor.jpg);"></div>
          <script type="application/json" class="w-json">
            {
              "items": [{
                "width": 2500,
                "caption": "Imagem meramente ilustrativa",
                "height": 1042,
                "fileName": "61fac58fc5ed659b4a8016f1_Planta-Humanizada_SecondFloor.jpg",
                "origFileName": "61fac58fc5ed659b4a8016f1_Planta-Humanizada_SecondFloor.jpg",
                "url": "<?= get_site_url() ?>/wp-content/uploads/2022/02/61fac58fc5ed659b4a8016f1_Planta-Humanizada_SecondFloor.jpg",
                "_id": "5f625e406e3e861a1db29b4c",
                "type": "image",
                "fileSize": 304920
              }]
            }
    ...
    <div class="div-block-18" style="text-align: center;">
      <a href="#formulario" class="button-34 itapeva w-button">Gostou? Entre em contato e conquiste seu novo lar!</a>
    </div>
  </div>
</div>
<div class="video-itapeva elvira wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 branco">Veja o que espera por você no <strong class="destaque-h2-laranja elvira">Residencial Elvira:</strong></h2>
    <div class="div-midia">
      ...
      <div class="owl-carousel" id="video-conceito" style="display:block;">

        <div class="div-video-2">
          <div class="centraliza" style="display: flex; justify-content: center;">
            <div class="w-embed w-iframe w-script owl-carousel">
              <div class="youtube-player item" data-id="hZGAP8Fv71c" style="background-image: url('https://urba.com.br/wp-content/uploads/2022/07/print-3.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
              <div class="youtube-player item" data-id="gj95aTYkq0Y" style="background-image: url('https://urba.com.br/wp-content/uploads/2022/05/Print-2.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
              <div class="youtube-player item" data-id="1Uxsuh2h1Yk" style="background-image: url('https://urba.com.br/wp-content/uploads/2022/05/Print-1.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="div-block-17">
    <a href="#formulario" class="button-3 elvira itapeva bot-o-hover-branco w-button">FALE AGORA COM A GENTE</a>
  </div>
</div>
</div>
</div>
...
<section id="formulario" class="formulario giardino wf-section">
  <div class="container-padrao">
    <div class="div-forms interna regatas">
      <h2 class="heading-2 forms">Gostou? Entre em <strong class="destaque-h2-laranja">Contato Conosco</strong></h2>
      <div class="w-form">
        <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="form-2">
          ...
          <div class="columns-9 w-row">
            ...
            <div class="column-70 w-col w-col-6"><input type="tel" class="text-field-2 w-input" maxlength="15" minlength="15" name="Telefone-2" data-name="Telefone-2" placeholder="Telefone" onkeypress="MascaraTelefone(this);" id="Telefone-2" required=""></div>

          </div>
          <select id="Select-lote" name="Select-lote" data-name="Select-lote" class="text-field-2 w-select">
            <option value="">Selecione o tipo de lote:</option>
            <option value="Lotes residenciais">Lotes residenciais</option>
            <option value="Lotes comerciais">Lotes comerciais</option>
          </select>
          <select id="Field-2" name="Field" data-name="Field" class="text-field-2 w-select">
            <option value="">Em quanto tempo você tem interesse em comprar seu terreno?</option>
          ...
          <div class="div-block-19">
            <p class="paragraph-16 itapeva text-form">Aceito receber via WhatsApp, ligação, e-mail e SMS, o contato da marca MRV&CO com novidades sobre este loteamento, bem como outras ações de marketing, ofertas de produto e serviços. Estou de acordo com as formas de tratamento de dados realizados pela marca MRV&CO, conforme sua <a href="https://www.mrv.com.br/institucional/pt/politica-de-privacidade">Política de Privacidade</a>.<br></p>
          ...
          </div><input type="submit" value="Enviar" data-wait="Aguarde..." class="submit-button-2 regatas w-button">
        </form>
        <!-- <div class="w-form-done">
            <div>Thank you! Your submission has been received!</div>
          </div>
...
<div class="multimidia giardino wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 forms">Sessão <strong class="destaque-h2">Multimídia</strong></h2>
    <div class="div-midia">
      <div style="padding-top:56.17021276595745%" class="w-embed-youtubevideo"><iframe src="https://www.youtube.com/embed/Ie-sEyUPxvs?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameborder="0" style="position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:auto" allow="autoplay; encrypted-media" allowfullscreen=""></iframe></div>
    </div>
  </div>
</div>
<style>
...
<div class="visite wf-section">
  <div class="container-padrao-3 w-container">
    ...
    <a href="https://goo.gl/maps/C7qSPcvPiEp2p6Yz5" target="_blank"> Rua Adail Gomes Ferreira 2100 Maracanã, Uberaba - MG / CEP: 38.041-006 </a>
    <!-- <a href="" target="_blank"> Contato aqui </a> -->
  </div>
</div>
<div class="micro-rodape wf-section">
  <div class="container-padrao w-container">
    <p class="paragraph-42">*Contrato padrão e demais condições estão disponíveis em nosso plantão de vendas. As condições de lançamento ora indicadas poderão sofrer alterações sem prévia comunicação ou anuência dos interessados, para adequação ao mercado. Este material tem caráter meramente ilustrativo por se tratar de bem a ser construído. Loteamento Registrado junto ao 1º Oficio de Registro de Imóveis de Uberaba sob o R.07/97.790, do dia 03 de maio de 2021 no Estado de Minas Gerais.</p>
  </div>
</div>
<?php get_footer(); ?>
<script async defer src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=5d5159338e8309099479b2ed" type="text/javascript" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>

<script async defer src="/wp-content/themes/urbamais/js/webflow.js" type="text/javascript"></script>
  ...
  jQuery('#email-form').submit(function(e) {
    ...
    if (jQuery('#E-mail').val() && regex.test(jQuery('#E-mail').val()) && jQuery('#name').val() && jQuery('#Telefone').val() && jQuery('input[name=consentimento-de-comunicacao]:checked').length > 0) {
      var data_array = [{
        ...
        {
          name: 'tipo-de-lote:',
          value: jQuery('#email-form #Menu-suspenso option:selected').val()
        },
        {
        ...
        {
          name: 'identificador',
          value: "Interesse Residencial Elvira"
  ...
  jQuery('#email-form-2').submit(function(e) {
    ...
    if (jQuery('#E-mail-2').val() && regex.test(jQuery('#E-mail-2').val()) && jQuery('#name-2').val() && jQuery('#Telefone-2').val() && jQuery('input[name=consentimento-de-comunicacao]:checked').length > 0) {
      var data_array = [{
        ...
        {
          name: 'tipo-de-lote:',
          value: jQuery('#email-form-2 #Select-lote option:selected').val()
        },
        {
          name: 'tempo_interesse:',
          value: jQuery('#email-form-2 #Field-2 option:selected').val()
        },
        {
          name: 'consentimento-de-comunicacao',
          value: 'granted'
