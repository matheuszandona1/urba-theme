<?php
/*
Template Name: Smart Urba Itapeva
...
<style>
  ...
  .hero-internas.itapeva {
    height: 800px;
    background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.2)), to(rgba(0, 0, 0, 0.2))), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/hero-itapeva.jpg);
    background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(<?= get_stylesheet_directory_uri() ?>/images/itapeva/hero-itapeva.jpg);
    background-position: 0px 0px, 50% 50%;
    background-size: auto, cover;
    background-repeat: repeat, repeat;
  }
...
<div id="hero" class="hero-internas itapeva wf-section">
  <div class="container-padrao reduzido">
    <div class="div-logos-hero itapeva"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/UR006921_RESESERVA_ITAPEVA-01.png" width="160" alt="" class="logo-itapeva"></div>
    <div class="div-info-hero">
      <div class="w-row">
        <div class="col-text w-col w-col-7">
          <div class="box itapeva">
            <h1 class="heading-36">Um bairro planejado em Itapeva, onde <span class="text-span-3">o prazer de viver está em cada detalhe</span><br><br></h1>
            <div class="div-box-preenchido-itapeva"></div>
            <div class="div-box-contorno itapeva"></div>
          </div>
          <h2 class="subtitle-lp itapeva">Sua oportunidade de <strong>morar em um bairro planejado</strong> com tudo o que você precisa para viver com mais qualidade de vida e bem-estar.<br></h2>
          <div class="tag-hero-2 destaque itapeva">tag para data de lançamento:</div>
          <div data-w-id="c8126cd7-14c6-c0a7-b595-1ab6ff32640b" class="feature"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icon-feature-3.svg" loading="lazy" width="35" alt="" class="image-16">
            <div class="text-block-45">Ampla área verde</div>
          </div>
          <div data-w-id="5c550d4b-d0e0-d686-6846-447ad16a86b8" class="feature"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icon-feature-3.svg" loading="lazy" width="35" alt="" class="image-16">
            <div class="text-block-45">Lazer e acessibilidade</div>
          </div>
          <div data-w-id="385bfa2b-86bd-1a4c-42d4-ebb50b056164" class="feature"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icon-feature-3.svg" loading="lazy" width="35" alt="" class="image-16">
            <div class="text-block-45">Comércio e serviços</div>
          </div>
        </div>
          ...
          <div class="div-forms-hero itapeva">
            ...
            <div class="w-form">
              <form id="email-form" name="email-form" data-name="Email Form" class="form-5">
                <input type="hidden" id="idempreendimento" name="idempreendimento" value="18">
                ...
                <div class="text-block-44">Aceito receber via WhatsApp, ligação, e-mail e SMS, o contato da marca MRV&CO com novidades sobre este loteamento, bem como outras ações de marketing, ofertas de produtos e serviços. Estou de acordo com as formas de tratamento de dados realizados pela marca MRV&CO, conforme sua <a href="https://www.mrv.com.br/institucional/pt/politica-de-privacidade" target="_blank" class="link-10">Política de Privacidade</a>.</div>
                <div class="div-block-5"><label class="w-checkbox checkbox-field">

                    <input type="checkbox" id="politica-privacidade" name="consentimento-de-comunicacao" value="Ok, entendi!" data-name="Ok, entendi!" required="" class="w-checkbox-input"><span for="Ok-entendi" class="checkbox-label-2 w-form-label">Ok, entendi!</span></label></div><input type="submit" value="CADASTRE-SE E SAIBA MAIS" data-wait="Aguarde..." class="enviar-form-lp-2 itapeva w-button">
              </form>
...
<div class="infos-terreno wf-section">
  <div class="container-padrao">
    <p class="paragraph-16 itapeva">A Urba está chegando em Itapeva, com um bairro planejado com<strong class="detaque-laranja"> infraestrutura completa</strong> e <strong class="detaque-laranja">áreas de lazer compartilhadas</strong>, totalmente pensado para oferecer o conforto e a tranquilidade que sua família merece. Terrenos em Itapeva/SP, residenciais e comerciais, para que você possa resolver tudo próximo de casa, com a praticidade e comodidade que o seu dia a dia requer.<br></p>
    <p class="paragraph-16 itapeva ipca" style="display: block;"><em>*corrigido pelo IPCA</em><br></p>
    <div class=" div-infos-terreno">
      <div data-w-id="5b2e0ec8-6296-3122-3294-a25915ec3bb0" class="div-info-terreno"><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/icone-pag-empreendimentos-terrenos.png" width="130" alt="" class="image-4">
        <div class="text-block-8">Terrenos de 175m² <br>a 306m²<br></div>
      </div>
    ...
    <div class="div-text-terreno cond">
      <div class="columns itapeva w-row" style="margin-top: 100px;">
  ...
  <div class="container-padrao">
    ...
    <div class="div-caracteristicas">
      <div data-w-id="86641039-24a1-7300-0730-6636ef260df0" class="div-caracteristica regatas">
        ...
        <p class="paragraph-17 regatas">

          Um bairro desenvolvido para que você more com muita <strong class="destaque-laranja">qualidade de vida</strong>.<br><br>Com infraestrutura completa, o Reserva Itapeva conta com 296 lotes, 100% das ruas asfaltadas, rede de água, esgoto, energia e paisagismo em todo o loteamento.
          <br><br>
        </p>
      </div>
      <div data-w-id="58f694a6-e2ea-5a2d-81ce-444659efc478" class="div-caracteristica regatas">
        <div class="imagem-caracteristica regatas _2" style="background-image: linear-gradient(180deg, transparent 46%, rgba(0, 0, 0, 0.5)), url(<?= get_site_url() ?>/wp-content/uploads/2022/02/61fabc25539bfa267b8b3d92_LAZER-p-1600.jpeg;">
          <h3 class="heading-7">Lazer</h3>
        </div>
        <p class="paragraph-17 regatas">Lazer bem pertinho de casa para viver momentos especiais em família. Área de convivência com <strong class="destaque-laranja">playground</strong> para as crianças, <strong class="destaque-laranja">espaço fitness</strong> para se exercitar, <strong class="destaque-laranja">quadra de areia</strong> para quem gosta de praticar esportes e <strong class="destaque-laranja">pet place</strong> para se divertir com seu bichinho.<br><br>Além disso, o bairro conta com mais de 21 mil m² de <strong class="destaque-laranja">áreas verdes</strong> e um espaço dedicado ao <strong class="destaque-laranja">pomar</strong> tornando o seu dia a dia mais próximo da natureza.</p>
      </div>
      ...
      <div data-w-id="48b6015e-7755-3c2e-600a-aca4e030d055" class="div-caracteristica regatas">
        ...
        <p class="paragraph-17 regatas">Pensando em <strong class="destaque-laranja">praticidade</strong> preparamos uma área de <strong class="destaque-laranja">lotes comerciais</strong> bem pertinho de casa, para acesso rápido a bens e serviços. <br><br>Se você é <strong class="destaque-laranja">comerciante</strong>, aproveite esta oportunidade em um bairro com potencial para <strong class="destaque-laranja">mais de 800 moradores</strong> e tenha o seu negócio em uma região promissora da cidade.<br></p>
        <div class="div-block-16">
          <a href="#hero" class="button-33 itapeva w-button">CLIQUE AQUI E SAIBA MAIS</a>
        </div>
      </div>
    </div>
    <div class="div-block-17">
      <a href="#formulario" class="button-3 itapeva w-button">SAIBA MAIS INFORMAÇÕES</a>
    </div>
  </div>
</div>
<!-- <div class="galeria-de-fotos itapeva wf-section">
  <div class="columns-5 w-row">
    <div class="column-25-copy w-col w-col-6">
      <div class="seta"></div>
      <div class="div-title-info-galeria">
        <h2 class="heading-2 galeria"><strong class="bold-text-23-copy">Explore</strong> o Loteamento <br>Reserva Itapeva na Galeria</h2><img src="<?= get_stylesheet_directory_uri() ?>/images/itapeva/5d8513de62711c50d3bfd4f6_arrow.png" alt="" class="image-60">
        <a href="#formulario" class="button-3 galeria w-button">Adquira já esse terreno</a>
      </div>
    </div>
    <?php $images = acf_photo_gallery('galeria', $post->ID); ?>
    <div class="column-26 regatas w-col w-col-6">
      <div data-delay="3000" data-animation="slide" class="slider-5 w-slider" data-autoplay="true" data-easing="ease-in" data-hide-arrows="true" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="5" data-duration="300" data-infinite="true">
        <div class="w-slider-mask">
          <div class="slide-11 w-slide">
            <div class="text-block-46"><em>Imagens meramente ilustrativas.</em></div>
            <a href="#" class="lightbox-link w-inline-block w-lightbox"><img src="<?php echo $images[0]['full_image_url']; ?>" height="400" width="640" loading="lazy" alt="" class="img-cover-galeria">
...
<div id="galeria" class="galeria-residencial-progresso wf-section">
  <div class="container-padrao-3 w-container">
    <p data-w-id="daf74de0-ded7-7623-7ec9-b27e0d686122" class="h1-2 verde-claro center">Explore o Loteamento Reserva Itapeva na Galeria:</p>
      ...
      <div class="w-slider-mask">
        <div class="w-slide">
          <div class="w-layout-grid grid-8">
            <a href="#" class="lightbox-link-10 lightbox-residencial-progresso w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 500w, https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 800w, https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 1080w, https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 1600w, https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 2000w, https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 2600w, https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 500px" alt="" class="image-66 imagem-residencial-progresso">
              ...
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    ...
                    "fileSize": 3780757,
                    "height": 2531,
                    "url": "https://urba.com.br/wp-content/uploads/2022/02/LAZER-Medio.jpg",
                    "width": 4500,
                    "caption": "Playground",
                    "type": "image"
                  }],
            ...
            <a href="#" class="lightbox-link-10 lightbox-residencial-progresso w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 500w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 800w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 2000w,https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 2600w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 500px" alt="" class="image-66 imagem-residencial-progresso">
              ...
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    ...
                    "fileSize": 3688694,
                    "height": 2531,
                    "url": "https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_RUA-04-OBSERVADOR_R03-1.jpg",
                    "width": 4500,
                    "caption": "Rua interna",
                    "type": "image"
                  }],
            ...
            <a href="#" class="lightbox-link-10 lightbox-residencial-progresso w-inline-block w-lightbox"><img src="https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg" loading="lazy" srcset="https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 500w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 800w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 1080w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 1600w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 2000w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 2600w, https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg 3200w" sizes="(max-width: 479px) 0px, (max-width: 767px) 100vw, 500px" alt="" class="image-66 imagem-residencial-progresso">
              ...
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    ...
                    "fileSize": 894686,
                    "height": 750,
                    "url": "https://urba.com.br/wp-content/uploads/2021/11/SQUAD_URBA_RESERVA-PRIME_IMG_AREA-COMERCIAL-OBSERVADOR_R03-1-1.jpg",
                    "width": 1000,
  ...
  <div class="columns-6 w-row">
    <div class="column-27 w-col w-col-5">
      <div class="div-title-info-localizacao">
        <h2 class="heading-2 localiz">Localização <strong>privilegiada</strong><br></h2>
        <p class="paragraph-16 localiz">O Reserva Itapeva conta com uma <strong class="detaque-laranja">ótima localização</strong>, às margens da Avenida Expedicionários de Itapeva, no trevo de acesso sentido aos municípios de Itararé e Itaberá, próximo à Rodovia Pedro Rodrigues García.<br></p>
      </div>
    </div>
      ...
      <div data-duration-in="300" data-duration-out="100" data-current="Tab 1" data-easing="ease" class="tabs w-tabs">
        ...
        <div class="w-tab-content">
          <div data-w-tab="Tab 1" class="tab-pane-tab-1 w-tab-pane w--tab-active">
            <div class="html-embed-2 w-embed w-iframe"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4371.876503940097!2d-48.90756760836875!3d-23.974444387242684!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjPCsDU4JzI4LjAiUyA0OMKwNTQnMjAuMSJX!5e1!3m2!1spt-BR!2sbr!4v1635445046806!5m2!1spt-BR!2sbr" width="100%" height="680px" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
          </div>
          <div data-w-tab="Tab 2" class="tab-pane-tab-2 w-tab-pane">
            <a href="#" class="lightbox-link-2 w-inline-block w-lightbox"><img src="<?= get_site_url() ?>/wp-content/uploads/2022/03/vista-aerea-itapeva.jpg" alt="" class="image-6">
              <script type="application/json" class="w-json">
                {
                  "items": [{
                    "width": 1920,
                    "caption": "",
                    "height": 1358,
                    "fileName": "vista-aerea-itapeva.jpg",
                    "origFileName": "vista-aerea-itapeva.jpg",
                    "url": "<?= get_site_url() ?>/wp-content/uploads/2022/03/vista-aerea-itapeva.jpg",
...
<div class="planta itapeva wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 center">No conceito de bairro planejado Urba, <strong class="destaque-h2 detaque-laranja">sua casa pode ser assim</strong></h2>
    <p class="paragraph-16">Fique à vontade para se inspirar com a sugestão de projeto que a Urba preparou para a sua futura casa!<br></p>
    ...
    <div class="columns-7 w-row">
      <div class="column-29 w-col w-col-8">
        <a href="#" data-w-id="c426b8fb-a8ab-f5fd-14fc-4df463ae0ee1" class="lightbox-link-4 w-inline-block w-lightbox">
          <div class="div-img-casa regatas" style="background-image:url(<?= get_site_url() ?>/wp-content/uploads/2022/02/Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_RESIDENCIAL_R03_POSTER_7680x4320.jpg);"></div>
          <script type="application/json" class="w-json">
            {
              "items": [{
                "width": 1422,
                "caption": "",
                "height": 800,
                "fileName": "Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_RESIDENCIAL_R03_POSTER_7680x4320.jpg",
                "origFileName": "Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_RESIDENCIAL_R03_POSTER_7680x4320",
                "url": "<?= get_site_url() ?>/wp-content/uploads/2022/02/Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_RESIDENCIAL_R03_POSTER_7680x4320.jpg);",
                "_id": "5577",
                "type": "image",
                "fileSize": 307821
              }]
      ...
      <div class="column-30 w-col w-col-2">
        <a href="#" data-w-id="2ba8ffd4-19cf-22a7-5f66-00feef640ffd" class="lightbox-link-3 w-inline-block w-lightbox">
          <div class="div-planta-01 regatas" style="background-image:url(<?= get_site_url() ?>/wp-content/uploads/2022/02/Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PAVIMENTO-TERREO_R02-1-scaled.jpg);"></div>
          <script type="application/json" class="w-json">
            {
              "items": [{
                "width": 2500,
                "caption": "",
                "height": 1042,
                "fileName": "Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PAVIMENTO-TERREO_R02-1-scaled.jpg",
                "origFileName": "Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PAVIMENTO-TERREO_R02-1-scaled.jpg",
                "url": "<?= get_site_url() ?>/wp-content/uploads/2022/02/Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PAVIMENTO-TERREO_R02-1-scaled.jpg",
      ...
      <div class="column-31 w-col w-col-2">
        <a href="#" data-w-id="15041d83-fed3-e9e7-68c3-6a3f2bf2b2b6" class="lightbox-link-5 w-inline-block w-lightbox">
          <div class="div-planta-02 regatas" style="background-image:url(<?= get_site_url() ?>/wp-content/uploads/2022/02/Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PRIMEIRO-PAVIMENTO_R02-1-scaled.jpg);"></div>
          <script type="application/json" class="w-json">
            {
              "items": [{
                "width": 2500,
                "caption": "",
                "height": 1042,
                "fileName": "Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PRIMEIRO-PAVIMENTO_R02-1-scaled.jpg",
                "origFileName": "Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PRIMEIRO-PAVIMENTO_R02-1-scaled.jpg",
                "url": "<?= get_site_url() ?>/wp-content/uploads/2022/02/Dobra-7-SQUAD_URBA_RESERVA-PRIME_IMG_PLANTA-PRIMEIRO-PAVIMENTO_R02-1-scaled.jpg",
...
<div class="video-itapeva wf-section">
  <div class="container-padrao">
    <h2 class="heading-2 branco">Veja o que espera por você no <strong class="destaque-h2 itapeva">Reserva Itapeva:</strong></h2>
    <div class="div-midia ">
        ...
        <div class="div-video-2">
          <div class="centraliza" style="display: flex; justify-content: center;">
            <div class="w-embed w-iframe w-script owl-carousel">
              <div class="youtube-player item" data-id="zluPVGscYhI" style="background-image: url('https://urba.com.br/wp-content/uploads/2022/03/print-2.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
              <div class="youtube-player item" data-id="VqaB9k17CTk" style="background-image: url('https://urba.com.br/wp-content/uploads/2022/03/print-1.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <!--<div style="padding-top:56.17021276595745%" class="w-embed-youtubevideo">        
               <div> <iframe src="https://www.youtube.com/embed/zluPVGscYhI?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameborder="0" style="position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:auto" allow="autoplay; encrypted-media" allowfullscreen=""></iframe></div>
               <div><iframe src="https://www.youtube.com/embed/VqaB9k17CTk?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameborder="0" style="position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:auto" allow="autoplay; encrypted-media" allowfullscreen=""></iframe></div> 
		</div>-->
  ...
  <div class="div-block-17">
    <a href="#formulario" class="button-3 itapeva bot-o-hover-branco w-button">FALE AGORA COM A GENTE</a>
  </div>
</div>
<div class="andamento-obra itapeva wf-section">
  <div class="container-padrao" style="text-align: center;">
    ...
    <div class="div-andamento">
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3df-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/pavimentacao.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba3e2" class="div-evolucao paisagismo" style="height:58%;"></div>
        </div>
        <div class="text-block-12">Pavimentação<br><strong class="bold-text-3">58%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba3e8-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/sinalizacao.png" width="60" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba3eb" class="div-evolucao pavimentacao" style="height:80%;"></div>
        </div>
        <div class="text-block-12">Sinalização<br><strong class="bold-text-3">80%</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icone-pag_empreendimentos-drenagem.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba418" class="div-evolucao areas-edificaveis" style="height:99%ss;"></div>
        </div>
        <div class="text-block-12">Drenagem<br><strong class="bold-text-3">99%ss</strong></div>
      </div>
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba415-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2022/11/icons_terraplanagem.png" width="80" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba418" class="div-evolucao areas-edificaveis" style="height:99%;"></div>
        </div>
      ...
      <div id="w-node-dc4c3ba3-bf99-2572-c13b-1063a43ba40c-b3181021" class="div-etapa">
        <div class="div-grafico"><img src="https://urba.com.br/wp-content/uploads/2023/01/area-lazer.png" width="60" alt="" class="image-7">
          <div data-w-id="dc4c3ba3-bf99-2572-c13b-1063a43ba418" class="div-evolucao paisagismo-progresso" style="height:99%;"></div>
        </div>
        <div class="text-block-12">Área de lazer<br><strong class="bold-text-3">99%</strong></div>
      </div>
    </div>
    ...
    <a href="#" class="lightbox-link-7 w-inline-block w-lightbox">
      ...
      <div class="w-form">
        <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="form-2">
          ...
          <div class="columns-9 w-row">
            ...
            <div class="column-70 w-col w-col-6"><input type="tel" class="text-field-2 w-input" minlength="15" maxlength="15" name="Telefone-2" data-name="Telefone-2" placeholder="Telefone" onkeypress="MascaraTelefone(this);" id="Telefone-2" required=""></div>
...
<div class="visite wf-section">
  <div class="container-padrao-3 w-container">
    ...
    <a href="https://goo.gl/maps/ad1aTZLExhzs9mze6" target="_blank">Rua Josué Xavier Gil, 99 - Parque Cimentolandia, Itapeva - SP | CEP: 18.409-639 </a>
  </div>
</div>
<div class="micro-rodape wf-section">
  <div class="container-padrao w-container">
    <p class="paragraph-42">Este material tem caráter meramente ilustrativo por se tratar de bem a ser construído. Contrato padrão e demais condições estão disponíveis em nosso plantão de vendas. Plano de 48x sem juros com correção de IPCA e parcela parcelada consulte condições. Plano de 144x com correção de IPCA, consulte condições. Loteamento Registrado no processo R07-41.119 no Estado de São Paulo na cidade de Itapeva no oficial de registro de imóveis, título e documentos e civil de pessoa jurídica da comarca de Itapeva.</p>
  </div>
</div>
<?php get_footer(); ?>
...
<script src="/wp-content/themes/urbamais/js/webflow.js" type="text/javascript"></script>
  ...
  jQuery('#email-form').submit(function(e) {
    ...
    if (jQuery('#E-mail').val() && regex.test(jQuery('#E-mail').val()) && jQuery('#name').val() && jQuery('#Telefone').val() && jQuery('input[name=consentimento-de-comunicacao]:checked').length > 0) {
      var data_array = [{
        ...
        {
          name: 'identificador',
          value: "Interesse Reserva Itapeva"
