          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="mb-2 mb-lg-0 mx-auto navbar-nav">
              ...
              <li class="nav-item menu-has-children">
                ...
                <ul class="submenu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/smart-urba/">Smart Urba</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/loteamentos-residenciais/">Loteamentos Residenciais</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/loteamentos-comerciais/">Loteamentos Comerciais</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item menu-has-children">
                <a class="nav-link" href="<?php echo site_url(); ?>/loteadora/">Conhe�0�4a a Urba</a>
                <ul class="submenu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/loteadora/">Institucional</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/codigo-de-conduta/">C��digo de Conduta</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/programa-de-integridade/">Programa de Integridade</a>
                  </li>
                  <li class="nav-item">
              ...
              <li class="nav-item menu-has-children">
                ...
                <ul class="submenu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url(); ?>/minha-casa-do-meu-jeito/">Minha Casa do Meu Jeito</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url(); ?>/area-do-cliente-urba">�0�9rea do Cliente</a>
              </li>
            </ul>
